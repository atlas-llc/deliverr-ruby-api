...
module DeliverrAPI
  class WebhookOrderStatusTest
    CREATED = "CREATED".freeze
    SHIPPED = "SHIPPED".freeze
    CANCELLED = "CANCELLED".freeze

    def self.all_vars
      @all_vars ||= [CREATED, SHIPPED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookOrderStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookOrderStatusTest"
    end
  end
end
