...
module DeliverrAPI
  class WebhookRequestMethodTest
    POST = "POST".freeze
    PUT = "PUT".freeze
    ...
    def build_from_hash(value)
      return value if WebhookRequestMethodTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookRequestMethodTest"
    end
  end
end
