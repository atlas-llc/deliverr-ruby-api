...
module DeliverrAPI
  class ParcelCreateRequestTest
    # An Order or PO number to associate to the parcel.
    attr_accessor :customer_parcel_id

    attr_accessor :service_level

    attr_accessor :injection_location
    ...
    attr_accessor :pickup_date_time
    ...
    def self.attribute_map
      {
        :'customer_parcel_id' => :'customerParcelId',
    ...
    def self.openapi_types
      {
        :'customer_parcel_id' => :'String',
        :'service_level' => :'ServiceLevelTest',
        :'injection_location' => :'InjectionLocationTest',
        :'ship_to_address' => :'ParcelAddressTest',
        :'return_address' => :'ParcelAddressTest',
        :'pickup_date_time' => :'Time',
        :'dimensions' => :'ParcelPackageDimensionsTest',
        :'customer_custom_field' => :'String',
        :'label_format' => :'ShippingLabelFormatTest',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ParcelCreateRequestTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ParcelCreateRequestTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'customer_parcel_id')
        self.customer_parcel_id = attributes[:'customer_parcel_id']
      end
      ...
      if attributes.key?(:'injection_location')
        self.injection_location = attributes[:'injection_location']
      end
      ...
      if attributes.key?(:'pickup_date_time')
        self.pickup_date_time = attributes[:'pickup_date_time']
      end
    ...
    def list_invalid_properties
      ...
      if @customer_parcel_id.nil?
        invalid_properties.push('invalid value for "customer_parcel_id", customer_parcel_id cannot be nil.')
      end
    ...
    def valid?
      return false if @customer_parcel_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          customer_parcel_id == o.customer_parcel_id &&
          service_level == o.service_level &&
          injection_location == o.injection_location &&
          ship_to_address == o.ship_to_address &&
          return_address == o.return_address &&
          pickup_date_time == o.pickup_date_time &&
    ...
    def hash
      [customer_parcel_id, service_level, injection_location, ship_to_address, return_address, pickup_date_time, dimensions, customer_custom_field, label_format, skip_address_validation].hash
    end
