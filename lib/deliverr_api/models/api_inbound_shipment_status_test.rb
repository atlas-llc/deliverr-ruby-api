...
module DeliverrAPI
  class ApiInboundShipmentStatusTest
    NEED_PACKAGE_DETAILS = "NEED_PACKAGE_DETAILS".freeze
    PACKAGES_ADDED = "PACKAGES_ADDED".freeze
    PACKAGES_FINAL = "PACKAGES_FINAL".freeze
    READY_FOR_WAREHOUSE = "READY_FOR_WAREHOUSE".freeze
    IN_TRANSIT = "IN_TRANSIT".freeze
    ARRIVED = "ARRIVED".freeze
    CROSS_DOCKING = "CROSS_DOCKING".freeze
    FORWARDING = "FORWARDING".freeze
    RECEIVING = "RECEIVING".freeze
    COMPLETED = "COMPLETED".freeze

    def self.all_vars
      @all_vars ||= [NEED_PACKAGE_DETAILS, PACKAGES_ADDED, PACKAGES_FINAL, READY_FOR_WAREHOUSE, IN_TRANSIT, ARRIVED, CROSS_DOCKING, FORWARDING, RECEIVING, COMPLETED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ApiInboundShipmentStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ApiInboundShipmentStatusTest"
    end
  end
end
