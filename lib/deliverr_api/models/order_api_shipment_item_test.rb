...
module DeliverrAPI
  class OrderApiShipmentItemTest
    ...
    # The total quantity of the product ordered. This helper information is on the SKU level and not per shipment level.
    attr_accessor :quantity_ordered

    # The quantity of the product shipped for this order and shipment.
    attr_accessor :quantity

    # The expiration date of the product for the shipped item in this shipment.
    attr_accessor :expiration_date

    # The lot information of the product for the shipped item in this shipment.
    ...
    def self.openapi_types
      {
        ...
        :'product_id' => :'String',
        :'line_item_id' => :'String',
        :'status' => :'ApiOrderShipmentStatusTest',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::OrderApiShipmentItemTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::OrderApiShipmentItemTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @quantity_ordered < 1
        invalid_properties.push('invalid value for "quantity_ordered", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @quantity_ordered < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] quantity_ordered Value to be assigned
    def quantity_ordered=(quantity_ordered)
      if quantity_ordered.nil?
        fail ArgumentError, 'quantity_ordered cannot be nil'
      end

      if quantity_ordered < 1
        fail ArgumentError, 'invalid value for "quantity_ordered", must be greater than or equal to 1.'
      end
    ...
    def hash
      [external_product_id, product_id, line_item_id, status, quantity_ordered, quantity, expiration_date, lot_number].hash
    end
