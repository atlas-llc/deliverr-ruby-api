...
module DeliverrAPI
  class LabelLanguageTest
    ...
    SPANISH = "SPANISH".freeze
    MANDARIN = "MANDARIN".freeze

    def self.all_vars
      @all_vars ||= [ENGLISH, SPANISH, MANDARIN].freeze
    end
    ...
    def build_from_hash(value)
      return value if LabelLanguageTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #LabelLanguageTest"
    end
  end
end
