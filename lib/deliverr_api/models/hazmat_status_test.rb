...
module DeliverrAPI
  class HazmatStatusTest
    ...
    def self.all_vars
      @all_vars ||= [PENDING, APPROVED, REJECTED, INCOMPLETE].freeze
    end
    ...
    def build_from_hash(value)
      return value if HazmatStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #HazmatStatusTest"
    end
  end
end
