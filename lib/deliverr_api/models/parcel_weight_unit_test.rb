...
module DeliverrAPI
  class ParcelWeightUnitTest
    KG = "kg".freeze
    LB = "lb".freeze

    def self.all_vars
      @all_vars ||= [KG, LB].freeze
    end
    ...
    def build_from_hash(value)
      return value if ParcelWeightUnitTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ParcelWeightUnitTest"
    end
  end
end
