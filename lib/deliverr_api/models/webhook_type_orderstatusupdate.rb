...
module Deliverr
  class WebhookTypeORDERSTATUSUPDATE
    ...
    def build_from_hash(value)
      return value if WebhookTypeORDERSTATUSUPDATE.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookTypeORDERSTATUSUPDATE"
    end
  end
end
