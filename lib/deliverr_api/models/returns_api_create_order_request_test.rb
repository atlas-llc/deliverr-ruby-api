...
module DeliverrAPI
  class ReturnsApiCreateOrderRequestTest
    ...
    # Whether to purchase label for return package(s)
    attr_accessor :is_purchase_label
    ...
    def self.attribute_map
      {
        ...
        :'is_purchase_label' => :'isPurchaseLabel'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'return_items' => :'Array<ReturnsApiReturnItemTest>',
        :'is_purchase_label' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ReturnsApiCreateOrderRequestTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ReturnsApiCreateOrderRequestTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_purchase_label')
        self.is_purchase_label = attributes[:'is_purchase_label']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_purchase_label == o.is_purchase_label
    end
    ...
    def hash
      [source_address, destination_address, customer, shipping_labels, marketplace_order, rma, external_return_id, return_items, is_purchase_label].hash
    end
