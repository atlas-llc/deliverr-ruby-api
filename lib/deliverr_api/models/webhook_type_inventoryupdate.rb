...
module Deliverr
  class WebhookTypeINVENTORYUPDATE
    ...
    def build_from_hash(value)
      return value if WebhookTypeINVENTORYUPDATE.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookTypeINVENTORYUPDATE"
    end
  end
end
