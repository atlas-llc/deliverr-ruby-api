...
module DeliverrAPI
  class TrackingStatusTest
    PRE_TRANSIT = "PRE_TRANSIT".freeze
    IN_TRANSIT = "IN_TRANSIT".freeze
    OUT_FOR_DELIVERY = "OUT_FOR_DELIVERY".freeze
    DELIVERED = "DELIVERED".freeze
    RETURN_TO_SENDER = "RETURN_TO_SENDER".freeze
    FAILURE = "FAILURE".freeze
    UNKNOWN = "UNKNOWN".freeze

    def self.all_vars
      @all_vars ||= [PRE_TRANSIT, IN_TRANSIT, OUT_FOR_DELIVERY, DELIVERED, RETURN_TO_SENDER, FAILURE, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if TrackingStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TrackingStatusTest"
    end
  end
end
