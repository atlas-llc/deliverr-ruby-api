...
module DeliverrAPI
  class StatusCodesCONFLICTTest
    N409 = 409.freeze

    def self.all_vars
      @all_vars ||= [N409].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesCONFLICTTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesCONFLICTTest"
    end
  end
end
