...
module DeliverrAPI
  class UnIdTest
    UN3481 = "UN3481".freeze
    UN3091 = "UN3091".freeze
    UN3480 = "UN3480".freeze
    UN3090 = "UN3090".freeze

    def self.all_vars
      @all_vars ||= [UN3481, UN3091, UN3480, UN3090].freeze
    end
    ...
    def build_from_hash(value)
      return value if UnIdTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #UnIdTest"
    end
  end
end
