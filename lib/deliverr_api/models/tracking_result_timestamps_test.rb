...
module DeliverrAPI
  class TrackingResultTimestampsTest
    ...
    attr_accessor :last_tracking_event_time

    # UTC timestamp of when the last tracking event for the package was ingested.
    attr_accessor :last_tracking_ingestion_time

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'label_time' => :'labelTime',
        :'arrival_scan_time' => :'arrivalScanTime',
        :'facility_time' => :'facilityTime',
        :'attempted_delivery_time' => :'attemptedDeliveryTime',
        :'delivery_time' => :'deliveryTime',
        :'estimated_delivery_time' => :'estimatedDeliveryTime',
        :'last_tracking_event_time' => :'lastTrackingEventTime',
        :'last_tracking_ingestion_time' => :'lastTrackingIngestionTime'
      }
    end
    ...
    def self.openapi_types
      {
        :'label_time' => :'Time',
        :'arrival_scan_time' => :'Time',
        :'facility_time' => :'Time',
        :'attempted_delivery_time' => :'Time',
        :'delivery_time' => :'Time',
        :'estimated_delivery_time' => :'Time',
        :'last_tracking_event_time' => :'Time',
        :'last_tracking_ingestion_time' => :'Time'
      }
    end
    ...
    def self.openapi_nullable
      Set.new([
        ...
        :'arrival_scan_time',
        :'facility_time',
        :'attempted_delivery_time',
        :'delivery_time',
        :'estimated_delivery_time',
        :'last_tracking_event_time',
        :'last_tracking_ingestion_time'
      ])
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::TrackingResultTimestampsTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::TrackingResultTimestampsTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'label_time')
        self.label_time = attributes[:'label_time']
      end

      if attributes.key?(:'arrival_scan_time')
        self.arrival_scan_time = attributes[:'arrival_scan_time']
      end

      if attributes.key?(:'facility_time')
        self.facility_time = attributes[:'facility_time']
      end

      if attributes.key?(:'attempted_delivery_time')
        self.attempted_delivery_time = attributes[:'attempted_delivery_time']
      end
      ...
      if attributes.key?(:'last_tracking_event_time')
        self.last_tracking_event_time = attributes[:'last_tracking_event_time']
      end

      if attributes.key?(:'last_tracking_ingestion_time')
        self.last_tracking_ingestion_time = attributes[:'last_tracking_ingestion_time']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          label_time == o.label_time &&
          arrival_scan_time == o.arrival_scan_time &&
          facility_time == o.facility_time &&
          attempted_delivery_time == o.attempted_delivery_time &&
          delivery_time == o.delivery_time &&
          estimated_delivery_time == o.estimated_delivery_time &&
          last_tracking_event_time == o.last_tracking_event_time &&
          last_tracking_ingestion_time == o.last_tracking_ingestion_time
    end
    ...
    def hash
      [label_time, arrival_scan_time, facility_time, attempted_delivery_time, delivery_time, estimated_delivery_time, last_tracking_event_time, last_tracking_ingestion_time].hash
    end
