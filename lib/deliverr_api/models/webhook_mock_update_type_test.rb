...
module DeliverrAPI
  class WebhookMockUpdateTypeTest
    SHIPPED = "SHIPPED".freeze
    INVENTORY_AVAILABLE = "INVENTORY_AVAILABLE".freeze

    def self.all_vars
      @all_vars ||= [SHIPPED, INVENTORY_AVAILABLE].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookMockUpdateTypeTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookMockUpdateTypeTest"
    end
  end
end
