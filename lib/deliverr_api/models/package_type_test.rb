...
module DeliverrAPI
  class PackageTypeTest
    ...
    # The number of packages shipped for this package type.
    attr_accessor :num_packages

    # The list of items shipped in this package type.
    attr_accessor :items
    ...
    def self.openapi_types
      {
        ...
        :'height' => :'Float',
        :'weight' => :'Float',
        :'dimension_unit' => :'LengthUnitTest',
        :'weight_unit' => :'WeightUnitTest',
        :'num_packages' => :'Float',
        :'items' => :'Array<ItemTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::PackageTypeTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::PackageTypeTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'num_packages')
        self.num_packages = attributes[:'num_packages']
      end
    ...
    def list_invalid_properties
      ...
      if !@length.nil? && @length < 0.01
        invalid_properties.push('invalid value for "length", must be greater than or equal to 0.01.')
      end

      if !@width.nil? && @width < 0.01
        invalid_properties.push('invalid value for "width", must be greater than or equal to 0.01.')
      end

      if !@height.nil? && @height < 0.01
        invalid_properties.push('invalid value for "height", must be greater than or equal to 0.01.')
      end

      if !@weight.nil? && @weight < 0.01
        invalid_properties.push('invalid value for "weight", must be greater than or equal to 0.01.')
      end

      if @num_packages.nil?
        invalid_properties.push('invalid value for "num_packages", num_packages cannot be nil.')
      end
    ...
    def valid?
      return false if !@length.nil? && @length < 0.01
      return false if !@width.nil? && @width < 0.01
      return false if !@height.nil? && @height < 0.01
      return false if !@weight.nil? && @weight < 0.01
      return false if @num_packages.nil?
    ...
    def length=(length)
      if !length.nil? && length < 0.01
        fail ArgumentError, 'invalid value for "length", must be greater than or equal to 0.01.'
      end
    ...
    def width=(width)
      if !width.nil? && width < 0.01
        fail ArgumentError, 'invalid value for "width", must be greater than or equal to 0.01.'
      end
    ...
    def height=(height)
      if !height.nil? && height < 0.01
        fail ArgumentError, 'invalid value for "height", must be greater than or equal to 0.01.'
      end
    ...
    def weight=(weight)
      if !weight.nil? && weight < 0.01
        fail ArgumentError, 'invalid value for "weight", must be greater than or equal to 0.01.'
      end
    ...
    def hash
      [length, width, height, weight, dimension_unit, weight_unit, num_packages, items].hash
    end
