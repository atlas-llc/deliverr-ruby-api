...
module DeliverrAPI
  class InboundStatusTest
    ...
    def self.all_vars
      @all_vars ||= [IN_DRAFT, READY_TO_SHIP, RECEIVING, COMPLETE, UNKNOWN, CREATED].freeze
    end
    ...
    def build_from_hash(value)
      return value if InboundStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InboundStatusTest"
    end
  end
end
