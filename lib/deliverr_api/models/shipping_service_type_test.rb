...
module DeliverrAPI
  class ShippingServiceTypeTest
    ...
    def build_from_hash(value)
      return value if ShippingServiceTypeTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShippingServiceTypeTest"
    end
  end
end
