...
module DeliverrAPI
  class StatusCodesACCEPTEDTest
    N202 = 202.freeze

    def self.all_vars
      @all_vars ||= [N202].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesACCEPTEDTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesACCEPTEDTest"
    end
  end
end
