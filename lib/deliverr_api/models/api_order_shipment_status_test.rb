...
module DeliverrAPI
  class ApiOrderShipmentStatusTest
    CREATED = "CREATED".freeze
    WAREHOUSE = "WAREHOUSE".freeze
    ERROR = "ERROR".freeze
    SHIPPED = "SHIPPED".freeze
    PARTIALLY_SHIPPED = "PARTIALLY_SHIPPED".freeze
    CANCELLED = "CANCELLED".freeze

    def self.all_vars
      @all_vars ||= [CREATED, WAREHOUSE, ERROR, SHIPPED, PARTIALLY_SHIPPED, CANCELLED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ApiOrderShipmentStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ApiOrderShipmentStatusTest"
    end
  end
end
