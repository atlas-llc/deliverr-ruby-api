...
module DeliverrAPI
  class StatusCodesINTERNALSERVERERRORTest
    N500 = 500.freeze

    def self.all_vars
      @all_vars ||= [N500].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesINTERNALSERVERERRORTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesINTERNALSERVERERRORTest"
    end
  end
end
