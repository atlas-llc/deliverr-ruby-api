...
module DeliverrAPI
  class ApiUpdateProductModelTest
    ...
    # height in inches of the product by itself. Will be ignored if provided and dimsLocked value is true from ProductModel.
    attr_accessor :height

    # Width in inches by itself. Will be ignored if provided and dimsLocked value is true from ProductModel.
    attr_accessor :width

    # Length in inches by itself. Will be ignored if provided and dimsLocked value is true from ProductModel.
    attr_accessor :length

    # Weight in pounds by itself. Will be ignored if provided and dimsLocked value is true from ProductModel.
    ...
    def self.openapi_types
      {
        :'title' => :'String',
        :'sku' => :'String',
        :'category' => :'CategoryEnumTest',
        :'height' => :'Float',
        :'width' => :'Float',
        :'length' => :'Float',
        :'weight' => :'Float',
        :'international' => :'MyPartialProductCustomsInfoTest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ApiUpdateProductModelTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ApiUpdateProductModelTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@sku.nil? && @sku.to_s.length > 255
    ...
    def valid?
      ...
      return false if !@sku.nil? && @sku.to_s.length > 255
    ...
    def hash
      [title, sku, category, height, width, length, weight, international].hash
    end
