...
module Deliverr
  class ApiOrderShipmentStatus
    ...
    def build_from_hash(value)
      return value if ApiOrderShipmentStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ApiOrderShipmentStatus"
    end
  end
end
