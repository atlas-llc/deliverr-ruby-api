...
module Deliverr
  class ReturnsPublicApiMarketplace
    ...
    def build_from_hash(value)
      return value if ReturnsPublicApiMarketplace.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReturnsPublicApiMarketplace"
    end
  end
end
