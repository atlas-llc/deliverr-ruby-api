...
module DeliverrAPI
  class ShipmentItemTest
    # The quantity of this product that is being shipped.
    attr_accessor :quantity

    # The quantity of this product that has been received.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ShipmentItemTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ShipmentItemTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @received_quantity.nil?
        invalid_properties.push('invalid value for "received_quantity", received_quantity cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @received_quantity.nil?
    ...
    def hash
      [quantity, received_quantity, product_id].hash
    end
