...
module DeliverrAPI
  class InventoryUpdateWebhookEventTest
    ...
    attr_accessor :inventory_available
    ...
    def self.openapi_types
      {
        :'event_time' => :'Time',
        :'event_id' => :'String',
        :'type' => :'WebhookTypeINVENTORYUPDATETest',
        :'product_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::InventoryUpdateWebhookEventTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::InventoryUpdateWebhookEventTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inventory_available')
        self.inventory_available = attributes[:'inventory_available']
      end
    end
    ...
    def hash
      [event_time, event_id, type, product_id, external_product_id, inventory_available].hash
    end
