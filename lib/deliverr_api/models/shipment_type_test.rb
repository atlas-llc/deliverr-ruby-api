...
module DeliverrAPI
  class ShipmentTypeTest
    FLOOR_LOADED_CONTAINER = "FLOOR_LOADED_CONTAINER".freeze
    PALLETIZED = "PALLETIZED".freeze

    def self.all_vars
      @all_vars ||= [FLOOR_LOADED_CONTAINER, PALLETIZED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ShipmentTypeTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShipmentTypeTest"
    end
  end
end
