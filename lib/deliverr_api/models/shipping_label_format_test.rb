...
module DeliverrAPI
  class ShippingLabelFormatTest
    PNG = "PNG".freeze
    ZPL203 = "ZPL203".freeze

    def self.all_vars
      @all_vars ||= [PNG, ZPL203].freeze
    end
    ...
    def build_from_hash(value)
      return value if ShippingLabelFormatTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShippingLabelFormatTest"
    end
  end
end
