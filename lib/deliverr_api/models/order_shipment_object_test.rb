...
module DeliverrAPI
  class OrderShipmentObjectTest
    # The unique tracking identifier for this shipment.
    ...
    # The tracking URL for a landing page to track the shipment.
    ...
    # Each shipment item object lists the individual items of a shipment. If a bundle was ordered, only the items of the bundles are listed, but not the bundle product itself.
    ...
    def self.openapi_types
      {
        ...
        :'shipping_carrier' => :'ShippingCarrierTypeTest',
        :'shipping_service' => :'ShippingServiceTypeTest',
        :'shipped_time' => :'Time',
        :'tracking_url' => :'String',
        :'warehouse_id' => :'WarehouseIdTypeTest',
        :'status' => :'ApiOrderShipmentStatusTest',
        :'shipped_items' => :'Array<OrderApiShipmentItemTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::OrderShipmentObjectTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::OrderShipmentObjectTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shipped_time')
        self.shipped_time = attributes[:'shipped_time']
      end
    ...
    def list_invalid_properties
      ...
      if @shipped_time.nil?
        invalid_properties.push('invalid value for "shipped_time", shipped_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shipped_time.nil?
    ...
    def hash
      [tracking_number, shipping_carrier, shipping_service, shipped_time, tracking_url, warehouse_id, status, shipped_items].hash
    end
