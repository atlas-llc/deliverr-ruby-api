...
module DeliverrAPI
  class StatusCodesUNPROCESSABLEENTITYTest
    N422 = 422.freeze

    def self.all_vars
      @all_vars ||= [N422].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesUNPROCESSABLEENTITYTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesUNPROCESSABLEENTITYTest"
    end
  end
end
