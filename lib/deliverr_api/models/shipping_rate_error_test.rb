...
module DeliverrAPI
  class ShippingRateErrorTest
    INVALID_ADDRESS = "INVALID_ADDRESS".freeze
    INVALID_CURRENCY = "INVALID_CURRENCY".freeze
    MISSING_SELLER_ID = "MISSING_SELLER_ID".freeze
    MISSING_SKUS = "MISSING_SKUS".freeze
    UNKNOWN_ERROR = "UNKNOWN_ERROR".freeze

    def self.all_vars
      @all_vars ||= [INVALID_ADDRESS, INVALID_CURRENCY, MISSING_SELLER_ID, MISSING_SKUS, UNKNOWN_ERROR].freeze
    end
    ...
    def build_from_hash(value)
      return value if ShippingRateErrorTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShippingRateErrorTest"
    end
  end
end
