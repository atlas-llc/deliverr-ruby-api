...
module DeliverrAPI
  class ParcelGetResponseTest
    ...
    # Errors associated with the parcel.
    attr_accessor :errors

    # Error messages associated with the parcel.
    ...
    # The billed weight in pounds (lbs).
    attr_accessor :billed_weight_lbs
    ...
    def self.attribute_map
      {
        ...
        :'billed_weight_lbs' => :'billedWeightLbs',
    ...
    def self.openapi_types
      {
        ...
        :'expired_tracking_data' => :'Array<ExpiredTrackingDataTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ParcelGetResponseTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ParcelGetResponseTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'billed_weight_lbs')
        self.billed_weight_lbs = attributes[:'billed_weight_lbs']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          billed_weight_lbs == o.billed_weight_lbs &&
    ...
    def hash
      [parcel_id, customer_reference_id, status, errors, error_message, shipping_label_url, package_tracking_url, price, service_level, customer_custom_field, carrier_code, tracking_code, billed_weight_lbs, dimensions, expired_tracking_data].hash
    end
