  ...
  class ParcelCreateRequest
    ...
    def self.openapi_types
      {
        ...
        :'service_level' => :'ServiceLevel',
        :'injection_location' => :'InjectionLocation',
        :'ship_to_address' => :'ParcelAddress',
        :'return_address' => :'ParcelAddress',
        :'pickup_date_time' => :'Time',
        :'dimensions' => :'ParcelPackageDimensions',
        :'customer_custom_field' => :'String',
        :'label_format' => :'ShippingLabelFormat',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Deliverr::ParcelCreateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Deliverr::ParcelCreateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
