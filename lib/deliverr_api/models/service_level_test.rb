...
module DeliverrAPI
  class ServiceLevelTest
    ...
    def self.all_vars
      @all_vars ||= [STANDARD, EXPEDITED, INTERNATIONAL].freeze
    end
    ...
    def build_from_hash(value)
      return value if ServiceLevelTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ServiceLevelTest"
    end
  end
end
