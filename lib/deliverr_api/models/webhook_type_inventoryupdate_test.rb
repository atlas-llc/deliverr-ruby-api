...
module DeliverrAPI
  class WebhookTypeINVENTORYUPDATETest
    INVENTORY_UPDATE = "INVENTORY_UPDATE".freeze

    def self.all_vars
      @all_vars ||= [INVENTORY_UPDATE].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookTypeINVENTORYUPDATETest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookTypeINVENTORYUPDATETest"
    end
  end
end
