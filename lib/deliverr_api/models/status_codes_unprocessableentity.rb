...
module Deliverr
  class StatusCodesUNPROCESSABLEENTITY
    N422 = 422.freeze
    ...
    def build_from_hash(value)
      return value if StatusCodesUNPROCESSABLEENTITY.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesUNPROCESSABLEENTITY"
    end
  end
end
