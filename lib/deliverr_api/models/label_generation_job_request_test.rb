...
module DeliverrAPI
  class LabelGenerationJobRequestTest
    attr_accessor :integration_channel_id

    # Estimated number of new orders to be purchased in this label generation job.
    attr_accessor :estimated_order_count
    ...
    def self.attribute_map
      {
        :'integration_channel_id' => :'integrationChannelId',
        :'estimated_order_count' => :'estimatedOrderCount'
      }
    end
    ...
    def self.openapi_types
      {
        :'integration_channel_id' => :'IntegrationChannelIdTest',
        :'estimated_order_count' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::LabelGenerationJobRequestTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::LabelGenerationJobRequestTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'integration_channel_id')
        self.integration_channel_id = attributes[:'integration_channel_id']
      end

      if attributes.key?(:'estimated_order_count')
        self.estimated_order_count = attributes[:'estimated_order_count']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @integration_channel_id.nil?
        invalid_properties.push('invalid value for "integration_channel_id", integration_channel_id cannot be nil.')
      end

      if @estimated_order_count.nil?
        invalid_properties.push('invalid value for "estimated_order_count", estimated_order_count cannot be nil.')
      end
    ...
    def valid?
      return false if @integration_channel_id.nil?
      return false if @estimated_order_count.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          integration_channel_id == o.integration_channel_id &&
          estimated_order_count == o.estimated_order_count
    end
    ...
    def hash
      [integration_channel_id, estimated_order_count].hash
    end
