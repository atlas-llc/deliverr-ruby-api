  ...
  class OrderStatusWebhookEvent
    ...
    def self.openapi_types
      {
        :'event_time' => :'Time',
        :'event_id' => :'String',
        :'type' => :'WebhookTypeORDERSTATUSUPDATE',
        :'update_type' => :'WebhookOrderStatus',
        :'old_status' => :'WebhookOrderStatus',
        :'new_status' => :'WebhookOrderStatus',
        :'order_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Deliverr::OrderStatusWebhookEvent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Deliverr::OrderStatusWebhookEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
