...
module DeliverrAPI
  class InjectionLocationTest
    EWR = "EWR".freeze
    LAX = "LAX".freeze
    DFW = "DFW".freeze

    def self.all_vars
      @all_vars ||= [EWR, LAX, DFW].freeze
    end
    ...
    def build_from_hash(value)
      return value if InjectionLocationTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InjectionLocationTest"
    end
  end
end
