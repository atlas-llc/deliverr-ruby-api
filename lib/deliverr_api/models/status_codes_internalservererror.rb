...
module Deliverr
  class StatusCodesINTERNALSERVERERROR
    N500 = 500.freeze
    ...
    def build_from_hash(value)
      return value if StatusCodesINTERNALSERVERERROR.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesINTERNALSERVERERROR"
    end
  end
end
