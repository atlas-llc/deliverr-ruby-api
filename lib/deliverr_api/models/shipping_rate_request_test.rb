...
module DeliverrAPI
  class ShippingRateRequestTest
    attr_accessor :destination

    # Array of Deliverr SKUs (DSKUs) in the cart. Request must contain either dskus or skus in order to generate a shipping rate.
    attr_accessor :dskus

    # Array of SKUs in the cart. Request must contain either dskus or skus in order to generate a shipping rate.
    attr_accessor :skus

    attr_accessor :cart_value
    ...
    def self.openapi_types
      {
        :'destination' => :'AddressTest',
        :'dskus' => :'Array<String>',
        :'skus' => :'Array<String>',
        :'cart_value' => :'PriceTest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ShippingRateRequestTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ShippingRateRequestTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dskus')
        if (value = attributes[:'dskus']).is_a?(Array)
          self.dskus = value
        end
      end
      ...
      if attributes.key?(:'cart_value')
        self.cart_value = attributes[:'cart_value']
      end
    end
    ...
    def hash
      [destination, dskus, skus, cart_value].hash
    end
