...
module DeliverrAPI
  class QcItemStatusTest
    INSPECTION_REJECTED = "INSPECTION_REJECTED".freeze
    INSPECTION_APPROVED = "INSPECTION_APPROVED".freeze
    LOST_DURING_INSPECTION = "LOST_DURING_INSPECTION".freeze
    LOST_BY_CARRIER = "LOST_BY_CARRIER".freeze
    DONATED = "DONATED".freeze
    DESTROYED = "DESTROYED".freeze
    NOT_RECEIVED = "NOT_RECEIVED".freeze
    RETURN_TO_SELLER = "RETURN_TO_SELLER".freeze
    LIQUIDATED = "LIQUIDATED".freeze

    def self.all_vars
      @all_vars ||= [INSPECTION_REJECTED, INSPECTION_APPROVED, LOST_DURING_INSPECTION, LOST_BY_CARRIER, DONATED, DESTROYED, NOT_RECEIVED, RETURN_TO_SELLER, LIQUIDATED].freeze
    end
    ...
    def build_from_hash(value)
      return value if QcItemStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #QcItemStatusTest"
    end
  end
end
