...
module DeliverrAPI
  class WebhookTypeORDERSTATUSUPDATETest
    ORDER_STATUS_UPDATE = "ORDER_STATUS_UPDATE".freeze

    def self.all_vars
      @all_vars ||= [ORDER_STATUS_UPDATE].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookTypeORDERSTATUSUPDATETest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookTypeORDERSTATUSUPDATETest"
    end
  end
end
