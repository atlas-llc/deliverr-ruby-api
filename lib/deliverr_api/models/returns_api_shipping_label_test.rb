...
module DeliverrAPI
  class ReturnsApiShippingLabelTest
    attr_accessor :carrier

    # Carrier tracking code.
    attr_accessor :tracking_code

    # Tracking url for shipping label.
    ...
    # Carrier label download url label format is required when passing label url.
    ...
    def self.openapi_types
      {
        :'carrier' => :'ReturnsPublicApiCarriersTest',
        :'tracking_code' => :'String',
        :'tracking_url' => :'String',
        :'tracking_status' => :'TrackingStatusTest',
        :'label_format' => :'String',
        :'label_url' => :'String',
        :'shipping_method' => :'ReturnsPublicApiShippingMethodTest',
        :'package_dimensions' => :'PackageDimensionsTest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ReturnsApiShippingLabelTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ReturnsApiShippingLabelTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @tracking_code.nil?
        invalid_properties.push('invalid value for "tracking_code", tracking_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tracking_code.nil?
      label_format_validator = EnumAttributeValidator.new('String', ["PDF", "PNG", "ZPL203"])
    ...
    def label_format=(label_format)
      validator = EnumAttributeValidator.new('String', ["PDF", "PNG", "ZPL203"])
    ...
    def hash
      [carrier, tracking_code, tracking_url, tracking_status, label_format, label_url, shipping_method, package_dimensions].hash
    end
