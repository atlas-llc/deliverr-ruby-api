...
module DeliverrAPI
  class ReturnsPublicApiMarketplaceTest
    AIRSHOP = "AIRSHOP".freeze
    AMAZON = "AMAZON".freeze
    ARTEZA = "ARTEZA".freeze
    ...
    JANE = "JANE".freeze
    JCPENNEY = "JCPENNEY".freeze
    KROGER = "KROGER".freeze
    MAGENTO = "MAGENTO".freeze
    NEWEGG = "NEWEGG".freeze
    OVERSTOCK = "OVERSTOCK".freeze
    SHOPIFY = "SHOPIFY".freeze
    SKUPREME = "SKUPREME".freeze
    TARGET = "TARGET".freeze
    WALMART = "WALMART".freeze
    WISH = "WISH".freeze
    WOOCOMMERCE = "WOOCOMMERCE".freeze
    OTHER = "OTHER".freeze

    def self.all_vars
      @all_vars ||= [AIRSHOP, AMAZON, ARTEZA, BIGCOMMERCE, DELIVERR, EBAY, ETSY, FACEBOOK, GOOGLE, INSTAGRAM, JANE, JCPENNEY, KROGER, MAGENTO, NEWEGG, OVERSTOCK, SHOPIFY, SKUPREME, TARGET, WALMART, WISH, WOOCOMMERCE, OTHER].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReturnsPublicApiMarketplaceTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReturnsPublicApiMarketplaceTest"
    end
  end
end
