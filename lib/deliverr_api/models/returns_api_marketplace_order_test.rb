...
module DeliverrAPI
  class ReturnsApiMarketplaceOrderTest
    ...
    def self.openapi_types
      {
        ...
        :'marketplace_name' => :'ReturnsPublicApiMarketplaceTest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ReturnsApiMarketplaceOrderTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ReturnsApiMarketplaceOrderTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'marketplace_order_id')
        self.marketplace_order_id = attributes[:'marketplace_order_id']
      end
    ...
    def list_invalid_properties
      ...
      if @marketplace_order_id.nil?
        invalid_properties.push('invalid value for "marketplace_order_id", marketplace_order_id cannot be nil.')
      end

      if @marketplace_name.nil?
        invalid_properties.push('invalid value for "marketplace_name", marketplace_name cannot be nil.')
      end
    ...
    def valid?
      return false if @marketplace_order_id.nil?
      return false if @marketplace_name.nil?
      true
    end
    ...
    def hash
      [marketplace_order_id, marketplace_name].hash
    end
