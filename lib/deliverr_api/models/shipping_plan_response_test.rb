...
module DeliverrAPI
  class ShippingPlanResponseTest
    ...
    # Deliverr's internal shipping plan identifier.
    ...
    # All items part of this shipping plan.
    attr_accessor :items

    # All shipments for this shipping plan.
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'ShippingPlanStatusTest',
        :'items' => :'Array<ItemTest>',
        :'shipments' => :'Array<ShipmentTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ShippingPlanResponseTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ShippingPlanResponseTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, external_shipping_plan_id, shipping_plan_id, from_address, status, items, shipments].hash
    end
