...
module DeliverrAPI
  class WebhookAuthTypeTest
    BASIC_AUTH = "BASIC_AUTH".freeze
    TOKEN = "TOKEN".freeze
    NONE = "NONE".freeze

    def self.all_vars
      @all_vars ||= [BASIC_AUTH, TOKEN, NONE].freeze
    end
    ...
    def build_from_hash(value)
      return value if WebhookAuthTypeTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WebhookAuthTypeTest"
    end
  end
end
