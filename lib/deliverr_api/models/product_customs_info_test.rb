  ...
  class ProductCustomsInfoTest
    ...
    def self.openapi_types
      {
        ...
        :'origin_country' => :'CountryCodeTest',
        :'customs_value' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ProductCustomsInfoTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ProductCustomsInfoTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'harmonized_code')
        self.harmonized_code = attributes[:'harmonized_code']
      end
    ...
    def list_invalid_properties
      ...
      if @customs_description.nil?
        invalid_properties.push('invalid value for "customs_description", customs_description cannot be nil.')
      end

      if @customs_description.to_s.length > 50
        invalid_properties.push('invalid value for "customs_description", the character length must be smaller than or equal to 50.')
      end

      if @customs_description.to_s.length < 1
        invalid_properties.push('invalid value for "customs_description", the character length must be great than or equal to 1.')
      end

      if @harmonized_code.nil?
        invalid_properties.push('invalid value for "harmonized_code", harmonized_code cannot be nil.')
      end

      pattern = Regexp.new(/^[0-9]{10}$/)
      if @harmonized_code !~ pattern
        invalid_properties.push("invalid value for \"harmonized_code\", must conform to the pattern #{pattern}.")
      end
      ...
      if @customs_value.nil?
        invalid_properties.push('invalid value for "customs_value", customs_value cannot be nil.')
      end

      if @customs_value < 0.01
        invalid_properties.push('invalid value for "customs_value", must be greater than or equal to 0.01.')
      end
    ...
    def valid?
      return false if @customs_description.nil?
      return false if @customs_description.to_s.length > 50
      return false if @customs_description.to_s.length < 1
      return false if @harmonized_code.nil?
      return false if @harmonized_code !~ Regexp.new(/^[0-9]{10}$/)
      return false if @origin_country.nil?
      return false if @customs_value.nil?
    ...
    def customs_description=(customs_description)
      if customs_description.nil?
        fail ArgumentError, 'customs_description cannot be nil'
      end
      ...
      if customs_description.to_s.length < 1
        fail ArgumentError, 'invalid value for "customs_description", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] harmonized_code Value to be assigned
    def harmonized_code=(harmonized_code)
      if harmonized_code.nil?
        fail ArgumentError, 'harmonized_code cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]{10}$/)
      if harmonized_code !~ pattern
        fail ArgumentError, "invalid value for \"harmonized_code\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] customs_value Value to be assigned
    def customs_value=(customs_value)
      if customs_value.nil?
        fail ArgumentError, 'customs_value cannot be nil'
      end

      if customs_value < 0.01
        fail ArgumentError, 'invalid value for "customs_value", must be greater than or equal to 0.01.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          harmonized_code == o.harmonized_code &&
    ...
    def hash
      [customs_description, harmonized_code, origin_country, customs_value].hash
    end
