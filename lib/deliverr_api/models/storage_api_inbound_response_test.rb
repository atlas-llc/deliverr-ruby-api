...
module DeliverrAPI
  class StorageApiInboundResponseTest
    ...
    def self.openapi_types
      {
        :'id' => :'Float',
        :'storage_items' => :'Array<StorageItemTest>',
        :'created_at' => :'Time',
        :'updated_at' => :'Time',
        :'asn_id' => :'String',
        ...
        :'shipment_id' => :'Float',
        :'warehouse_id' => :'String',
        :'from' => :'DeliverrAddressTest',
        :'to' => :'DeliverrAddressTest',
        :'status' => :'InboundStatusTest',
        :'shipment_type' => :'ShipmentTypeTest',
        :'seller_id' => :'String',
        :'shipment_pro' => :'String',
        :'bol_link' => :'String',
        ...
        :'pallet_count' => :'Float',
        :'container_id' => :'String',
        :'container_size' => :'ContainerSizeTest',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::StorageApiInboundResponseTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::StorageApiInboundResponseTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
