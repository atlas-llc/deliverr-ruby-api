...
module DeliverrAPI
  class StatusCodesFORBIDDENTest
    N403 = 403.freeze

    def self.all_vars
      @all_vars ||= [N403].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesFORBIDDENTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesFORBIDDENTest"
    end
  end
end
