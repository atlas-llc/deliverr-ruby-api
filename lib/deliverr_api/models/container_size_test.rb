...
module DeliverrAPI
  class ContainerSizeTest
    N20_FT = "GENERAL_20FT".freeze
    N40_FT = "GENERAL_40FT".freeze

    def self.all_vars
      @all_vars ||= [N20_FT, N40_FT].freeze
    end
    ...
    def build_from_hash(value)
      return value if ContainerSizeTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ContainerSizeTest"
    end
  end
end
