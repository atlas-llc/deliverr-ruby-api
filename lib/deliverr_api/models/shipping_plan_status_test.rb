...
module DeliverrAPI
  class ShippingPlanStatusTest
    ARCHIVED = "ARCHIVED".freeze
    PENDING = "PENDING".freeze
    SHIPMENTS_CREATED = "SHIPMENTS_CREATED".freeze

    def self.all_vars
      @all_vars ||= [ARCHIVED, PENDING, SHIPMENTS_CREATED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ShippingPlanStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ShippingPlanStatusTest"
    end
  end
end
