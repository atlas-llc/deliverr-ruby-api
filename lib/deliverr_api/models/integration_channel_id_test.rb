...
module DeliverrAPI
  class IntegrationChannelIdTest
    SHIPSTATION = "shipstation".freeze

    def self.all_vars
      @all_vars ||= [SHIPSTATION].freeze
    end
    ...
    def build_from_hash(value)
      return value if IntegrationChannelIdTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #IntegrationChannelIdTest"
    end
  end
end
