...
module DeliverrAPI
  class StatusCodesBADREQUESTTest
    N400 = 400.freeze

    def self.all_vars
      @all_vars ||= [N400].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesBADREQUESTTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesBADREQUESTTest"
    end
  end
end
