...
module DeliverrAPI
  class WebhookCreateModelTest
    attr_accessor :type

    # Webhook URL for where Deliverr events should be sent to. Must begin with 'https://'.
    attr_accessor :url
    ...
    def self.openapi_types
      {
        ...
        :'url' => :'String',
        :'method' => :'WebhookRequestMethodTest',
        :'auth_method' => :'WebhookAuthTypeTest',
        :'username' => :'String',
        :'password' => :'String',
        :'token' => :'String',
        :'token_header' => :'String'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::WebhookCreateModelTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::WebhookCreateModelTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'token_header')
        self.token_header = attributes[:'token_header']
      end
    end
    ...
    def hash
      [type, url, method, auth_method, username, password, token, token_header].hash
    end
