...
module DeliverrAPI
  class ShippingPlanRequestTest
    # Name of the shipping plan.
    attr_accessor :name

    # The seller's shipping plan identifier.
    attr_accessor :external_shipping_plan_id

    attr_accessor :from_address

    # The crossdock identifier where the packages will be shipped to.
    attr_accessor :destination

    # The list of all items part of this shipping plan.
    attr_accessor :items

    # The list of different package types part of this shipping plan. Each package type can represent multiple packages.
    ...
    def self.attribute_map
      {
        :'name' => :'name',
        :'external_shipping_plan_id' => :'externalShippingPlanId',
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'external_shipping_plan_id' => :'String',
        :'from_address' => :'AddressTest',
        :'destination' => :'String',
        :'items' => :'Array<PlanItemTest>',
        :'package_types' => :'Array<PackageTypeTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ShippingPlanRequestTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ShippingPlanRequestTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'external_shipping_plan_id')
        self.external_shipping_plan_id = attributes[:'external_shipping_plan_id']
      end
    ...
    def list_invalid_properties
      ...
      if @external_shipping_plan_id.nil?
        invalid_properties.push('invalid value for "external_shipping_plan_id", external_shipping_plan_id cannot be nil.')
      end
      ...
      if @package_types.nil?
        invalid_properties.push('invalid value for "package_types", package_types cannot be nil.')
      end
    ...
    def valid?
      return false if @external_shipping_plan_id.nil?
      return false if @from_address.nil?
      return false if @destination.nil?
      return false if @items.nil?
      return false if @package_types.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          external_shipping_plan_id == o.external_shipping_plan_id &&
    ...
    def hash
      [name, external_shipping_plan_id, from_address, destination, items, package_types].hash
    end
