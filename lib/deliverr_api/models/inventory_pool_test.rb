...
module DeliverrAPI
  class InventoryPoolTest
    ...
    UNALLOCATED = "UNALLOCATED".freeze
    STORAGE = "STORAGE".freeze

    def self.all_vars
      @all_vars ||= [DEFAULT, UNALLOCATED, STORAGE].freeze
    end
    ...
    def build_from_hash(value)
      return value if InventoryPoolTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #InventoryPoolTest"
    end
  end
end
