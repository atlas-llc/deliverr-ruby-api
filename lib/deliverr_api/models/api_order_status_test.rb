...
module DeliverrAPI
  class ApiOrderStatusTest
    ...
    def self.all_vars
      @all_vars ||= [CREATED, ERROR, SHIPPED, PARTIALLY_SHIPPED, DELIVERED, CANCELLED, PROCESSING].freeze
    end
    ...
    def build_from_hash(value)
      return value if ApiOrderStatusTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ApiOrderStatusTest"
    end
  end
end
