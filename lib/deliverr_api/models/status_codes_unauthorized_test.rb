...
module DeliverrAPI
  class StatusCodesUNAUTHORIZEDTest
    N401 = 401.freeze

    def self.all_vars
      @all_vars ||= [N401].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesUNAUTHORIZEDTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesUNAUTHORIZEDTest"
    end
  end
end
