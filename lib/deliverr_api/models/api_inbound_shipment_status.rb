...
module Deliverr
  class ApiInboundShipmentStatus
    ...
    def build_from_hash(value)
      return value if ApiInboundShipmentStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ApiInboundShipmentStatus"
    end
  end
end
