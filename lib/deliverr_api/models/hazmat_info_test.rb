...
module DeliverrAPI
  class HazmatInfoTest
    attr_accessor :hazmat_code

    attr_accessor :hazmat_status
    ...
    def self.openapi_types
      {
        :'hazmat_code' => :'UnIdTest',
        :'hazmat_status' => :'HazmatStatusTest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::HazmatInfoTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::HazmatInfoTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'hazmat_code')
        self.hazmat_code = attributes[:'hazmat_code']
      end

      if attributes.key?(:'hazmat_status')
        self.hazmat_status = attributes[:'hazmat_status']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @hazmat_code.nil?
        invalid_properties.push('invalid value for "hazmat_code", hazmat_code cannot be nil.')
      end

      if @hazmat_status.nil?
        invalid_properties.push('invalid value for "hazmat_status", hazmat_status cannot be nil.')
      end
    ...
    def valid?
      return false if @hazmat_code.nil?
      return false if @hazmat_status.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          hazmat_code == o.hazmat_code &&
          hazmat_status == o.hazmat_status
    end
    ...
    def hash
      [hazmat_code, hazmat_status].hash
    end
