...
module DeliverrAPI
  class CategoryEnumTest
    ADULT = "ADULT".freeze
    APPAREL_FABRIC_PLUSH_TEXTILES = "APPAREL_FABRIC_PLUSH_TEXTILES".freeze
    BABY = "BABY".freeze
    FRAGILE_GLASS = "FRAGILE_GLASS".freeze
    NON_GLASS_LIQUIDS = "NON_GLASS_LIQUIDS".freeze
    OTHER = "OTHER".freeze
    PERFORATED_PACKAGING = "PERFORATED_PACKAGING".freeze
    POWDER_PELLETS_GRANULAR = "POWDER_PELLETS_GRANULAR".freeze
    SHARP = "SHARP".freeze
    SMALL = "SMALL".freeze

    def self.all_vars
      @all_vars ||= [ADULT, APPAREL_FABRIC_PLUSH_TEXTILES, BABY, FRAGILE_GLASS, NON_GLASS_LIQUIDS, OTHER, PERFORATED_PACKAGING, POWDER_PELLETS_GRANULAR, SHARP, SMALL].freeze
    end
    ...
    def build_from_hash(value)
      return value if CategoryEnumTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CategoryEnumTest"
    end
  end
end
