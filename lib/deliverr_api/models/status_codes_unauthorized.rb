...
module Deliverr
  class StatusCodesUNAUTHORIZED
    ...
    def build_from_hash(value)
      return value if StatusCodesUNAUTHORIZED.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesUNAUTHORIZED"
    end
  end
end
