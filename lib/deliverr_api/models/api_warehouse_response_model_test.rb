...
module DeliverrAPI
  class ApiWarehouseResponseModelTest
    ...
    attr_accessor :warehouse_details
    ...
    def self.openapi_types
      {
        :'product_id' => :'String',
        :'warehouse_details' => :'Array<WarehouseDetailsTest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DeliverrAPI::ApiWarehouseResponseModelTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DeliverrAPI::ApiWarehouseResponseModelTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'warehouse_details')
        if (value = attributes[:'warehouse_details']).is_a?(Array)
          self.warehouse_details = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          warehouse_details == o.warehouse_details
    end
    ...
    def hash
      [product_id, warehouse_details].hash
    end
