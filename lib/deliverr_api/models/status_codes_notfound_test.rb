...
module DeliverrAPI
  class StatusCodesNOTFOUNDTest
    N404 = 404.freeze

    def self.all_vars
      @all_vars ||= [N404].freeze
    end
    ...
    def build_from_hash(value)
      return value if StatusCodesNOTFOUNDTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StatusCodesNOTFOUNDTest"
    end
  end
end
