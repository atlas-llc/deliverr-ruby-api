...
module DeliverrAPI
  class BoxLabelsFormatTest
    US_LETTER = "US_LETTER".freeze
    THERMAL_4_X_6 = "THERMAL_4_X_6".freeze
    A4_PAPER = "A4_PAPER".freeze

    def self.all_vars
      @all_vars ||= [US_LETTER, THERMAL_4_X_6, A4_PAPER].freeze
    end
    ...
    def build_from_hash(value)
      return value if BoxLabelsFormatTest.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #BoxLabelsFormatTest"
    end
  end
end
