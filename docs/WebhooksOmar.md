# DeliverrAPI::WebhooksOmar

All URIs are relative to *http://localhost:3000*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**create_webhook**](WebhooksOmar.md#create_webhook) | **POST** /webhooks/v1/webhook |  |
| [**delete_webhook**](WebhooksOmar.md#delete_webhook) | **DELETE** /webhooks/v1/webhook/{webhookId} |  |
| [**get_webhook**](WebhooksOmar.md#get_webhook) | **GET** /webhooks/v1/webhook/{webhookId} |  |
| [**get_webhooks**](WebhooksOmar.md#get_webhooks) | **GET** /webhooks/v1/webhook |  |
| [**trigger_mock_webhook_event**](WebhooksOmar.md#trigger_mock_webhook_event) | **POST** /webhooks/v1/event |  |
...
begin
  ...
  puts "Error when calling WebhooksOmar->create_webhook: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->create_webhook_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->delete_webhook: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->delete_webhook_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->get_webhook: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->get_webhook_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->get_webhooks: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->get_webhooks_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->trigger_mock_webhook_event: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhooksOmar->trigger_mock_webhook_event_with_http_info: #{e}"
end
```
