...
# Unit tests for DeliverrAPI::OAuthOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OAuthOmar' do
  before do
  ...
  describe 'test an instance of OAuthOmar' do
    it 'should create an instance of OAuthOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::OAuthOmar)
    end
  end
