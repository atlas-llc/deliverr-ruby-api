...
# Unit tests for DeliverrAPI::ProductsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductsTest' do
  before do
  ...
  describe 'test an instance of ProductsTest' do
    it 'should create an instance of ProductsTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ProductsTest)
    end
  end
