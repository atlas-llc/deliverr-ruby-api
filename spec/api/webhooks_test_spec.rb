...
# Unit tests for DeliverrAPI::WebhooksTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebhooksTest' do
  before do
  ...
  describe 'test an instance of WebhooksTest' do
    it 'should create an instance of WebhooksTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::WebhooksTest)
    end
  end
