...
# Unit tests for DeliverrAPI::BundlesOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BundlesOmar' do
  before do
  ...
  describe 'test an instance of BundlesOmar' do
    it 'should create an instance of BundlesOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::BundlesOmar)
    end
  end
