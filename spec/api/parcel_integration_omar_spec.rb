...
# Unit tests for DeliverrAPI::ParcelIntegrationOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParcelIntegrationOmar' do
  before do
  ...
  describe 'test an instance of ParcelIntegrationOmar' do
    it 'should create an instance of ParcelIntegrationOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ParcelIntegrationOmar)
    end
  end
