...
# Unit tests for DeliverrAPI::ReturnsOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReturnsOmar' do
  before do
  ...
  describe 'test an instance of ReturnsOmar' do
    it 'should create an instance of ReturnsOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ReturnsOmar)
    end
  end

  # unit tests for cancel_order_return
  # Cancel a return that was create. Return will not be cancelled if it is received.
  # @param x_caller_id The caller identifier.
  # @param return_id Unique ID used to track the return.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'cancel_order_return test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_order_return
  # Creates return order for inspection.
  # @param x_caller_id The caller identifier.
  # @param returns_api_create_order_request 
  # @param [Hash] opts the optional parameters
  # @return [ReturnsApiOrder]
  describe 'create_order_return test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_order_return
  # Get return by returnId. This will include ReturnOrder, ReturnItems with inspection status and ShippingLabel.
  # @param x_caller_id The caller identifier.
  # @param return_id Unique ID used to track the return.
  # @param [Hash] opts the optional parameters
  # @return [ReturnsApiOrder]
  describe 'get_order_return test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
