...
# Unit tests for DeliverrAPI::OrdersOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrdersOmar' do
  before do
  ...
  describe 'test an instance of OrdersOmar' do
    it 'should create an instance of OrdersOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::OrdersOmar)
    end
  end
