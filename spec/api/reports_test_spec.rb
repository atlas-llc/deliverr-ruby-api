...
# Unit tests for DeliverrAPI::ReportsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReportsTest' do
  before do
  ...
  describe 'test an instance of ReportsTest' do
    it 'should create an instance of ReportsTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ReportsTest)
    end
  end
