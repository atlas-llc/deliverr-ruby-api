...
# Unit tests for DeliverrAPI::StorageOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StorageOmar' do
  before do
  ...
  describe 'test an instance of StorageOmar' do
    it 'should create an instance of StorageOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::StorageOmar)
    end
  end
