...
# Unit tests for DeliverrAPI::ReturnsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ReturnsTest' do
  before do
  ...
  describe 'test an instance of ReturnsTest' do
    it 'should create an instance of ReturnsTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ReturnsTest)
    end
  end
