...
# Unit tests for DeliverrAPI::ParcelsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParcelsTest' do
  before do
  ...
  describe 'test an instance of ParcelsTest' do
    it 'should create an instance of ParcelsTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ParcelsTest)
    end
  end
