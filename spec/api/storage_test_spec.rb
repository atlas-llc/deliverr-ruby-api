...
# Unit tests for DeliverrAPI::StorageTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StorageTest' do
  before do
  ...
  describe 'test an instance of StorageTest' do
    it 'should create an instance of StorageTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::StorageTest)
    end
  end

  # unit tests for get_inbound_order
  # Get storage inbound by storageInboundId. This will include StorageInboundOrder, StorageInboundItems with status .
  # @param shipping_plan_id Unique ID used to get the storageInboundCreated.
  # @param [Hash] opts the optional parameters
  # @return [StorageApiInboundResponse]
  describe 'get_inbound_order test' do
    it 'should work' do
