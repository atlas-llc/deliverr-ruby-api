...
# Unit tests for DeliverrAPI::ParcelIntegrationTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParcelIntegrationTest' do
  before do
  ...
  describe 'test an instance of ParcelIntegrationTest' do
    it 'should create an instance of ParcelIntegrationTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ParcelIntegrationTest)
    end
  end

  # unit tests for create_label_generation_job
  # Initiate a label generation process.
  # @param label_generation_job_request 
  # @param [Hash] opts the optional parameters
  # @return [LabelGenerationJobResponse]
  describe 'create_label_generation_job test' do
    it 'should work' do
