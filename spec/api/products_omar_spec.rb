...
# Unit tests for DeliverrAPI::ProductsOmar
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ProductsOmar' do
  before do
  ...
  describe 'test an instance of ProductsOmar' do
    it 'should create an instance of ProductsOmar' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ProductsOmar)
    end
  end
