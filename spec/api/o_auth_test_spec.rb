...
# Unit tests for DeliverrAPI::OAuthTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OAuthTest' do
  before do
  ...
  describe 'test an instance of OAuthTest' do
    it 'should create an instance of OAuthTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::OAuthTest)
    end
  end
