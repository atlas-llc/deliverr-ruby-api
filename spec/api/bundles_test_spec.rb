...
# Unit tests for DeliverrAPI::BundlesTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BundlesTest' do
  before do
  ...
  describe 'test an instance of BundlesTest' do
    it 'should create an instance of BundlesTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::BundlesTest)
    end
  end
