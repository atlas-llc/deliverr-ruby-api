...
# Unit tests for DeliverrAPI::OrdersTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrdersTest' do
  before do
  ...
  describe 'test an instance of OrdersTest' do
    it 'should create an instance of OrdersTest' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::OrdersTest)
    end
  end
