...
# Unit tests for DeliverrAPI::ReturnsApiShippingLabelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiShippingLabelTest do
  let(:instance) { DeliverrAPI::ReturnsApiShippingLabelTest.new }

  describe 'test an instance of ReturnsApiShippingLabelTest' do
    it 'should create an instance of ReturnsApiShippingLabelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiShippingLabelTest)
    end
  end
  ...
  describe 'test attribute "label_format"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PDF", "PNG", "ZPL203"])
