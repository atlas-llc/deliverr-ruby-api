...
# Unit tests for DeliverrAPI::ApiUpdateProductModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiUpdateProductModelTest do
  let(:instance) { DeliverrAPI::ApiUpdateProductModelTest.new }

  describe 'test an instance of ApiUpdateProductModelTest' do
    it 'should create an instance of ApiUpdateProductModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiUpdateProductModelTest)
    end
  end
