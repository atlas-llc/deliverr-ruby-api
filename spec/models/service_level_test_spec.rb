...
# Unit tests for DeliverrAPI::ServiceLevelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ServiceLevelTest do
  let(:instance) { DeliverrAPI::ServiceLevelTest.new }

  describe 'test an instance of ServiceLevelTest' do
    it 'should create an instance of ServiceLevelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ServiceLevelTest)
    end
  end
end
