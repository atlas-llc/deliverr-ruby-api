...
# Unit tests for DeliverrAPI::ReportStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportStatusTest do
  let(:instance) { DeliverrAPI::ReportStatusTest.new }

  describe 'test an instance of ReportStatusTest' do
    it 'should create an instance of ReportStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportStatusTest)
    end
  end
end
