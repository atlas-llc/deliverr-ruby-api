...
# Unit tests for DeliverrAPI::ReturnsApiMarketplaceOrderTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiMarketplaceOrderTest do
  let(:instance) { DeliverrAPI::ReturnsApiMarketplaceOrderTest.new }

  describe 'test an instance of ReturnsApiMarketplaceOrderTest' do
    it 'should create an instance of ReturnsApiMarketplaceOrderTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiMarketplaceOrderTest)
    end
  end
  describe 'test attribute "marketplace_order_id"' do
    it 'should work' do
