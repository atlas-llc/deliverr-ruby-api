...
# Unit tests for DeliverrAPI::StatusCodesFORBIDDENTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesFORBIDDENTest do
  let(:instance) { DeliverrAPI::StatusCodesFORBIDDENTest.new }

  describe 'test an instance of StatusCodesFORBIDDENTest' do
    it 'should create an instance of StatusCodesFORBIDDENTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesFORBIDDENTest)
    end
  end
end
