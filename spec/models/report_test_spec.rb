...
# Unit tests for DeliverrAPI::ReportTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportTest do
  let(:instance) { DeliverrAPI::ReportTest.new }

  describe 'test an instance of ReportTest' do
    it 'should create an instance of ReportTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportTest)
    end
  end
  ...
  describe 'test attribute "url_expiration"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
