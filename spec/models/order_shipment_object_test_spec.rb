...
# Unit tests for DeliverrAPI::OrderShipmentObjectTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderShipmentObjectTest do
  let(:instance) { DeliverrAPI::OrderShipmentObjectTest.new }

  describe 'test an instance of OrderShipmentObjectTest' do
    it 'should create an instance of OrderShipmentObjectTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderShipmentObjectTest)
    end
  end
  ...
  describe 'test attribute "shipped_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
