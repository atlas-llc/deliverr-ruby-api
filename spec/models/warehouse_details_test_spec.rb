...
# Unit tests for DeliverrAPI::WarehouseDetailsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WarehouseDetailsTest do
  let(:instance) { DeliverrAPI::WarehouseDetailsTest.new }

  describe 'test an instance of WarehouseDetailsTest' do
    it 'should create an instance of WarehouseDetailsTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WarehouseDetailsTest)
    end
  end
