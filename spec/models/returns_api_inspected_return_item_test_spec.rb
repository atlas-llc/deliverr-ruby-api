...
# Unit tests for DeliverrAPI::ReturnsApiInspectedReturnItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiInspectedReturnItemTest do
  let(:instance) { DeliverrAPI::ReturnsApiInspectedReturnItemTest.new }

  describe 'test an instance of ReturnsApiInspectedReturnItemTest' do
    it 'should create an instance of ReturnsApiInspectedReturnItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiInspectedReturnItemTest)
    end
  end
  ...
  describe 'test attribute "expected_quantity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
