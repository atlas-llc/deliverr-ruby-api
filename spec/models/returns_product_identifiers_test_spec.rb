...
# Unit tests for DeliverrAPI::ReturnsProductIdentifiersTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsProductIdentifiersTest do
  let(:instance) { DeliverrAPI::ReturnsProductIdentifiersTest.new }

  describe 'test an instance of ReturnsProductIdentifiersTest' do
    it 'should create an instance of ReturnsProductIdentifiersTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsProductIdentifiersTest)
    end
  end
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DELIVERR_SKU", "FNSKU", "SHOPIFY_PRODUCT_ID", "PRODUCT_NAME", "SHOPIFY_VARIANT_ID", "SKU", "UPC", "LOT_NUMBER", "OTHER"])
