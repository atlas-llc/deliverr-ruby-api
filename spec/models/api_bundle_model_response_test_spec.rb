...
# Unit tests for DeliverrAPI::ApiBundleModelResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleModelResponseTest do
  let(:instance) { DeliverrAPI::ApiBundleModelResponseTest.new }

  describe 'test an instance of ApiBundleModelResponseTest' do
    it 'should create an instance of ApiBundleModelResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleModelResponseTest)
    end
  end
  describe 'test attribute "external_bundle_id"' do
    it 'should work' do
  ...
  describe 'test attribute "bundle_contents"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
