...
# Unit tests for DeliverrAPI::WebhookTypeINVENTORYUPDATETest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookTypeINVENTORYUPDATETest do
  let(:instance) { DeliverrAPI::WebhookTypeINVENTORYUPDATETest.new }

  describe 'test an instance of WebhookTypeINVENTORYUPDATETest' do
    it 'should create an instance of WebhookTypeINVENTORYUPDATETest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookTypeINVENTORYUPDATETest)
    end
  end
end
