...
# Unit tests for DeliverrAPI::ParcelTrackingGetResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelTrackingGetResponseTest do
  let(:instance) { DeliverrAPI::ParcelTrackingGetResponseTest.new }

  describe 'test an instance of ParcelTrackingGetResponseTest' do
    it 'should create an instance of ParcelTrackingGetResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelTrackingGetResponseTest)
    end
  end
  ...
  describe 'test attribute "event_timestamps"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
