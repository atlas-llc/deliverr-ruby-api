...
# Unit tests for DeliverrAPI::CategoryEnumTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::CategoryEnumTest do
  let(:instance) { DeliverrAPI::CategoryEnumTest.new }

  describe 'test an instance of CategoryEnumTest' do
    it 'should create an instance of CategoryEnumTest' do
      expect(instance).to be_instance_of(DeliverrAPI::CategoryEnumTest)
    end
  end
end
