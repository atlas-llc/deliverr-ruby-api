...
# Unit tests for DeliverrAPI::InjectionLocationTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InjectionLocationTest do
  let(:instance) { DeliverrAPI::InjectionLocationTest.new }

  describe 'test an instance of InjectionLocationTest' do
    it 'should create an instance of InjectionLocationTest' do
      expect(instance).to be_instance_of(DeliverrAPI::InjectionLocationTest)
    end
  end
end
