...
# Unit tests for DeliverrAPI::PackageDimensionsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PackageDimensionsTest do
  let(:instance) { DeliverrAPI::PackageDimensionsTest.new }

  describe 'test an instance of PackageDimensionsTest' do
    it 'should create an instance of PackageDimensionsTest' do
      expect(instance).to be_instance_of(DeliverrAPI::PackageDimensionsTest)
    end
  end
