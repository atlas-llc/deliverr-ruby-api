...
# Unit tests for DeliverrAPI::MyPartialProductCustomsInfoTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::MyPartialProductCustomsInfoTest do
  let(:instance) { DeliverrAPI::MyPartialProductCustomsInfoTest.new }

  describe 'test an instance of MyPartialProductCustomsInfoTest' do
    it 'should create an instance of MyPartialProductCustomsInfoTest' do
      expect(instance).to be_instance_of(DeliverrAPI::MyPartialProductCustomsInfoTest)
    end
  end
  ...
  describe 'test attribute "harmonized_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
