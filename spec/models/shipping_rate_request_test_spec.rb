...
# Unit tests for DeliverrAPI::ShippingRateRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateRequestTest do
  let(:instance) { DeliverrAPI::ShippingRateRequestTest.new }

  describe 'test an instance of ShippingRateRequestTest' do
    it 'should create an instance of ShippingRateRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateRequestTest)
    end
  end
  ...
  describe 'test attribute "dskus"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "cart_value"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
