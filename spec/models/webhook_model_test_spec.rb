...
# Unit tests for DeliverrAPI::WebhookModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookModelTest do
  let(:instance) { DeliverrAPI::WebhookModelTest.new }

  describe 'test an instance of WebhookModelTest' do
    it 'should create an instance of WebhookModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookModelTest)
    end
  end
