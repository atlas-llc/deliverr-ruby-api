...
# Unit tests for DeliverrAPI::ApiProductModelResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiProductModelResponseTest do
  let(:instance) { DeliverrAPI::ApiProductModelResponseTest.new }

  describe 'test an instance of ApiProductModelResponseTest' do
    it 'should create an instance of ApiProductModelResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiProductModelResponseTest)
    end
  end
  ...
  describe 'test attribute "bundle_memberships"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dims_locked"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "hazmat_info"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
