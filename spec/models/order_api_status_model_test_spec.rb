...
# Unit tests for DeliverrAPI::OrderApiStatusModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiStatusModelTest do
  let(:instance) { DeliverrAPI::OrderApiStatusModelTest.new }

  describe 'test an instance of OrderApiStatusModelTest' do
    it 'should create an instance of OrderApiStatusModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiStatusModelTest)
    end
  end
  ...
  describe 'test attribute "order_shipped_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "order_delivered_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
