...
# Unit tests for DeliverrAPI::InternalServerErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InternalServerErrorTest do
  let(:instance) { DeliverrAPI::InternalServerErrorTest.new }

  describe 'test an instance of InternalServerErrorTest' do
    it 'should create an instance of InternalServerErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::InternalServerErrorTest)
    end
  end
