...
# Unit tests for DeliverrAPI::BadCreateShippingRequestErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadCreateShippingRequestErrorTest do
  let(:instance) { DeliverrAPI::BadCreateShippingRequestErrorTest.new }

  describe 'test an instance of BadCreateShippingRequestErrorTest' do
    it 'should create an instance of BadCreateShippingRequestErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BadCreateShippingRequestErrorTest)
    end
  end
