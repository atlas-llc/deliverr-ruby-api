...
# Unit tests for DeliverrAPI::WebhookMockUpdateTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookMockUpdateTypeTest do
  let(:instance) { DeliverrAPI::WebhookMockUpdateTypeTest.new }

  describe 'test an instance of WebhookMockUpdateTypeTest' do
    it 'should create an instance of WebhookMockUpdateTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookMockUpdateTypeTest)
    end
  end
end
