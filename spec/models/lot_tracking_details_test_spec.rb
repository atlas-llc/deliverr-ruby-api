...
# Unit tests for DeliverrAPI::LotTrackingDetailsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LotTrackingDetailsTest do
  let(:instance) { DeliverrAPI::LotTrackingDetailsTest.new }

  describe 'test an instance of LotTrackingDetailsTest' do
    it 'should create an instance of LotTrackingDetailsTest' do
      expect(instance).to be_instance_of(DeliverrAPI::LotTrackingDetailsTest)
    end
  end
