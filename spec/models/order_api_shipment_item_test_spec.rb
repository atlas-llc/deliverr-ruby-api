...
# Unit tests for DeliverrAPI::OrderApiShipmentItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiShipmentItemTest do
  let(:instance) { DeliverrAPI::OrderApiShipmentItemTest.new }

  describe 'test an instance of OrderApiShipmentItemTest' do
    it 'should create an instance of OrderApiShipmentItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiShipmentItemTest)
    end
  end
