...
# Unit tests for DeliverrAPI::StatusCodesUNAUTHORIZEDTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesUNAUTHORIZEDTest do
  let(:instance) { DeliverrAPI::StatusCodesUNAUTHORIZEDTest.new }

  describe 'test an instance of StatusCodesUNAUTHORIZEDTest' do
    it 'should create an instance of StatusCodesUNAUTHORIZEDTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesUNAUTHORIZEDTest)
    end
  end
end
