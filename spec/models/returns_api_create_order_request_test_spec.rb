...
# Unit tests for DeliverrAPI::ReturnsApiCreateOrderRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiCreateOrderRequestTest do
  let(:instance) { DeliverrAPI::ReturnsApiCreateOrderRequestTest.new }

  describe 'test an instance of ReturnsApiCreateOrderRequestTest' do
    it 'should create an instance of ReturnsApiCreateOrderRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiCreateOrderRequestTest)
    end
  end
  ...
  describe 'test attribute "is_purchase_label"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
