...
# Unit tests for DeliverrAPI::ShippingRateErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateErrorTest do
  let(:instance) { DeliverrAPI::ShippingRateErrorTest.new }

  describe 'test an instance of ShippingRateErrorTest' do
    it 'should create an instance of ShippingRateErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateErrorTest)
    end
  end
end
