...
# Unit tests for DeliverrAPI::CountryCodeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::CountryCodeTest do
  let(:instance) { DeliverrAPI::CountryCodeTest.new }

  describe 'test an instance of CountryCodeTest' do
    it 'should create an instance of CountryCodeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::CountryCodeTest)
    end
  end
end
