...
# Unit tests for DeliverrAPI::ItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ItemTest do
  let(:instance) { DeliverrAPI::ItemTest.new }

  describe 'test an instance of ItemTest' do
    it 'should create an instance of ItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ItemTest)
    end
  end
