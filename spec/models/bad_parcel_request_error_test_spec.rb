...
# Unit tests for DeliverrAPI::BadParcelRequestErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadParcelRequestErrorTest do
  let(:instance) { DeliverrAPI::BadParcelRequestErrorTest.new }

  describe 'test an instance of BadParcelRequestErrorTest' do
    it 'should create an instance of BadParcelRequestErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BadParcelRequestErrorTest)
    end
  end
