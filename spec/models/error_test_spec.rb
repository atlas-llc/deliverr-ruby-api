...
# Unit tests for DeliverrAPI::ErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ErrorTest do
  let(:instance) { DeliverrAPI::ErrorTest.new }

  describe 'test an instance of ErrorTest' do
    it 'should create an instance of ErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ErrorTest)
    end
  end
