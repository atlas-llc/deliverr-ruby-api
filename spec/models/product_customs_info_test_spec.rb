...
# Unit tests for DeliverrAPI::ProductCustomsInfoTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ProductCustomsInfoTest do
  let(:instance) { DeliverrAPI::ProductCustomsInfoTest.new }

  describe 'test an instance of ProductCustomsInfoTest' do
    it 'should create an instance of ProductCustomsInfoTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ProductCustomsInfoTest)
    end
  end
