...
# Unit tests for DeliverrAPI::BundleMembershipTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BundleMembershipTest do
  let(:instance) { DeliverrAPI::BundleMembershipTest.new }

  describe 'test an instance of BundleMembershipTest' do
    it 'should create an instance of BundleMembershipTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BundleMembershipTest)
    end
  end
