...
# Unit tests for DeliverrAPI::HazmatStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::HazmatStatusTest do
  let(:instance) { DeliverrAPI::HazmatStatusTest.new }

  describe 'test an instance of HazmatStatusTest' do
    it 'should create an instance of HazmatStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::HazmatStatusTest)
    end
  end
end
