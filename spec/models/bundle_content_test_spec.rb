...
# Unit tests for DeliverrAPI::BundleContentTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BundleContentTest do
  let(:instance) { DeliverrAPI::BundleContentTest.new }

  describe 'test an instance of BundleContentTest' do
    it 'should create an instance of BundleContentTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BundleContentTest)
    end
  end
