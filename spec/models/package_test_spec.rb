...
# Unit tests for DeliverrAPI::PackageTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PackageTest do
  let(:instance) { DeliverrAPI::PackageTest.new }

  describe 'test an instance of PackageTest' do
    it 'should create an instance of PackageTest' do
      expect(instance).to be_instance_of(DeliverrAPI::PackageTest)
    end
  end
  ...
  describe 'test attribute "cdsku"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
