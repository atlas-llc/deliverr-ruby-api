...
# Unit tests for DeliverrAPI::ParcelStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelStatusTest do
  let(:instance) { DeliverrAPI::ParcelStatusTest.new }

  describe 'test an instance of ParcelStatusTest' do
    it 'should create an instance of ParcelStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelStatusTest)
    end
  end
end
