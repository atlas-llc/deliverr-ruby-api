...
# Unit tests for DeliverrAPI::ParcelGetResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelGetResponseTest do
  let(:instance) { DeliverrAPI::ParcelGetResponseTest.new }

  describe 'test an instance of ParcelGetResponseTest' do
    it 'should create an instance of ParcelGetResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelGetResponseTest)
    end
  end
