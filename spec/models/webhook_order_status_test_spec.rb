...
# Unit tests for DeliverrAPI::WebhookOrderStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookOrderStatusTest do
  let(:instance) { DeliverrAPI::WebhookOrderStatusTest.new }

  describe 'test an instance of WebhookOrderStatusTest' do
    it 'should create an instance of WebhookOrderStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookOrderStatusTest)
    end
  end
end
