...
# Unit tests for DeliverrAPI::ReturnsPublicApiShippingMethodTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiShippingMethodTest do
  let(:instance) { DeliverrAPI::ReturnsPublicApiShippingMethodTest.new }

  describe 'test an instance of ReturnsPublicApiShippingMethodTest' do
    it 'should create an instance of ReturnsPublicApiShippingMethodTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiShippingMethodTest)
    end
  end
end
