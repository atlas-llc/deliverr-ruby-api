...
# Unit tests for DeliverrAPI::OrderApiLineItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiLineItemTest do
  let(:instance) { DeliverrAPI::OrderApiLineItemTest.new }

  describe 'test an instance of OrderApiLineItemTest' do
    it 'should create an instance of OrderApiLineItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiLineItemTest)
    end
  end
