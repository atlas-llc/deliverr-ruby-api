...
# Unit tests for DeliverrAPI::TrackingStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::TrackingStatusTest do
  let(:instance) { DeliverrAPI::TrackingStatusTest.new }

  describe 'test an instance of TrackingStatusTest' do
    it 'should create an instance of TrackingStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::TrackingStatusTest)
    end
  end
end
