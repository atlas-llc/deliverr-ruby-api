...
# Unit tests for DeliverrAPI::ReturnsApiOrderTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiOrderTest do
  let(:instance) { DeliverrAPI::ReturnsApiOrderTest.new }

  describe 'test an instance of ReturnsApiOrderTest' do
    it 'should create an instance of ReturnsApiOrderTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiOrderTest)
    end
  end
