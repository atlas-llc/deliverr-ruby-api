...
# Unit tests for DeliverrAPI::PlanItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PlanItemTest do
  let(:instance) { DeliverrAPI::PlanItemTest.new }

  describe 'test an instance of PlanItemTest' do
    it 'should create an instance of PlanItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::PlanItemTest)
    end
  end
  ...
  describe 'test attribute "case_quantity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
