...
# Unit tests for DeliverrAPI::ExpiredTrackingDataTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ExpiredTrackingDataTest do
  let(:instance) { DeliverrAPI::ExpiredTrackingDataTest.new }

  describe 'test an instance of ExpiredTrackingDataTest' do
    it 'should create an instance of ExpiredTrackingDataTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ExpiredTrackingDataTest)
    end
  end
