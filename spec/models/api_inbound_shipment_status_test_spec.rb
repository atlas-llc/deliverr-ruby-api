...
# Unit tests for DeliverrAPI::ApiInboundShipmentStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiInboundShipmentStatusTest do
  let(:instance) { DeliverrAPI::ApiInboundShipmentStatusTest.new }

  describe 'test an instance of ApiInboundShipmentStatusTest' do
    it 'should create an instance of ApiInboundShipmentStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiInboundShipmentStatusTest)
    end
  end
end
