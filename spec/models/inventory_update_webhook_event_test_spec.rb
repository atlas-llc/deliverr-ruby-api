...
# Unit tests for DeliverrAPI::InventoryUpdateWebhookEventTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InventoryUpdateWebhookEventTest do
  let(:instance) { DeliverrAPI::InventoryUpdateWebhookEventTest.new }

  describe 'test an instance of InventoryUpdateWebhookEventTest' do
    it 'should create an instance of InventoryUpdateWebhookEventTest' do
      expect(instance).to be_instance_of(DeliverrAPI::InventoryUpdateWebhookEventTest)
    end
  end
  ...
  describe 'test attribute "inventory_available"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
