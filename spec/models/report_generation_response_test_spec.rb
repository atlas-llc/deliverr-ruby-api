...
# Unit tests for DeliverrAPI::ReportGenerationResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportGenerationResponseTest do
  let(:instance) { DeliverrAPI::ReportGenerationResponseTest.new }

  describe 'test an instance of ReportGenerationResponseTest' do
    it 'should create an instance of ReportGenerationResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportGenerationResponseTest)
    end
  end
  describe 'test attribute "report_reference"' do
    it 'should work' do
