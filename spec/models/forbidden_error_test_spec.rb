...
# Unit tests for DeliverrAPI::ForbiddenErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ForbiddenErrorTest do
  let(:instance) { DeliverrAPI::ForbiddenErrorTest.new }

  describe 'test an instance of ForbiddenErrorTest' do
    it 'should create an instance of ForbiddenErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ForbiddenErrorTest)
    end
  end
