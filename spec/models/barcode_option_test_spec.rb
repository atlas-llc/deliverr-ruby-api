...
# Unit tests for DeliverrAPI::BarcodeOptionTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BarcodeOptionTest do
  let(:instance) { DeliverrAPI::BarcodeOptionTest.new }

  describe 'test an instance of BarcodeOptionTest' do
    it 'should create an instance of BarcodeOptionTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BarcodeOptionTest)
    end
  end
  describe 'test attribute "barcode_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PRODUCT", "MANUFACTURER", "AMAZON"])
