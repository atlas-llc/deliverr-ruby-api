...
# Unit tests for DeliverrAPI::UnIdTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnIdTest do
  let(:instance) { DeliverrAPI::UnIdTest.new }

  describe 'test an instance of UnIdTest' do
    it 'should create an instance of UnIdTest' do
      expect(instance).to be_instance_of(DeliverrAPI::UnIdTest)
    end
  end
end
