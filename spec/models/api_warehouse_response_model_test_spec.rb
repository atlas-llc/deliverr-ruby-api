...
# Unit tests for DeliverrAPI::ApiWarehouseResponseModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiWarehouseResponseModelTest do
  let(:instance) { DeliverrAPI::ApiWarehouseResponseModelTest.new }

  describe 'test an instance of ApiWarehouseResponseModelTest' do
    it 'should create an instance of ApiWarehouseResponseModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiWarehouseResponseModelTest)
    end
  end
  ...
  describe 'test attribute "warehouse_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
