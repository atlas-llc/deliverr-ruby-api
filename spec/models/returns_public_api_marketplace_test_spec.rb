...
# Unit tests for DeliverrAPI::ReturnsPublicApiMarketplaceTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiMarketplaceTest do
  let(:instance) { DeliverrAPI::ReturnsPublicApiMarketplaceTest.new }

  describe 'test an instance of ReturnsPublicApiMarketplaceTest' do
    it 'should create an instance of ReturnsPublicApiMarketplaceTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiMarketplaceTest)
    end
  end
end
