...
# Unit tests for DeliverrAPI::ParcelWeightUnitTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelWeightUnitTest do
  let(:instance) { DeliverrAPI::ParcelWeightUnitTest.new }

  describe 'test an instance of ParcelWeightUnitTest' do
    it 'should create an instance of ParcelWeightUnitTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelWeightUnitTest)
    end
  end
end
