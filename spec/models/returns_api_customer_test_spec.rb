...
# Unit tests for DeliverrAPI::ReturnsApiCustomerTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiCustomerTest do
  let(:instance) { DeliverrAPI::ReturnsApiCustomerTest.new }

  describe 'test an instance of ReturnsApiCustomerTest' do
    it 'should create an instance of ReturnsApiCustomerTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiCustomerTest)
    end
  end
