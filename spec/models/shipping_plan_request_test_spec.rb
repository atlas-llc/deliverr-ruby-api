...
# Unit tests for DeliverrAPI::ShippingPlanRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanRequestTest do
  let(:instance) { DeliverrAPI::ShippingPlanRequestTest.new }

  describe 'test an instance of ShippingPlanRequestTest' do
    it 'should create an instance of ShippingPlanRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanRequestTest)
    end
  end
