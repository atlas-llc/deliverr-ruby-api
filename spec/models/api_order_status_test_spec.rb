...
# Unit tests for DeliverrAPI::ApiOrderStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiOrderStatusTest do
  let(:instance) { DeliverrAPI::ApiOrderStatusTest.new }

  describe 'test an instance of ApiOrderStatusTest' do
    it 'should create an instance of ApiOrderStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiOrderStatusTest)
    end
  end
end
