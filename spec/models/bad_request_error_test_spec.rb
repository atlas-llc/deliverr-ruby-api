...
# Unit tests for DeliverrAPI::BadRequestErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadRequestErrorTest do
  let(:instance) { DeliverrAPI::BadRequestErrorTest.new }

  describe 'test an instance of BadRequestErrorTest' do
    it 'should create an instance of BadRequestErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BadRequestErrorTest)
    end
  end
