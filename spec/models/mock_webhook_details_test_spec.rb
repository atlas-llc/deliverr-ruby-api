...
# Unit tests for DeliverrAPI::MockWebhookDetailsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::MockWebhookDetailsTest do
  let(:instance) { DeliverrAPI::MockWebhookDetailsTest.new }

  describe 'test an instance of MockWebhookDetailsTest' do
    it 'should create an instance of MockWebhookDetailsTest' do
      expect(instance).to be_instance_of(DeliverrAPI::MockWebhookDetailsTest)
    end
  end
