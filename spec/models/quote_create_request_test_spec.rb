...
# Unit tests for DeliverrAPI::QuoteCreateRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QuoteCreateRequestTest do
  let(:instance) { DeliverrAPI::QuoteCreateRequestTest.new }

  describe 'test an instance of QuoteCreateRequestTest' do
    it 'should create an instance of QuoteCreateRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::QuoteCreateRequestTest)
    end
  end
