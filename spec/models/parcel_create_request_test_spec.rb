...
# Unit tests for DeliverrAPI::ParcelCreateRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCreateRequestTest do
  let(:instance) { DeliverrAPI::ParcelCreateRequestTest.new }

  describe 'test an instance of ParcelCreateRequestTest' do
    it 'should create an instance of ParcelCreateRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCreateRequestTest)
    end
  end
  describe 'test attribute "customer_parcel_id"' do
    it 'should work' do
  ...
  describe 'test attribute "injection_location"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "pickup_date_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
