...
# Unit tests for DeliverrAPI::DeliverrAddressTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::DeliverrAddressTest do
  let(:instance) { DeliverrAPI::DeliverrAddressTest.new }

  describe 'test an instance of DeliverrAddressTest' do
    it 'should create an instance of DeliverrAddressTest' do
      expect(instance).to be_instance_of(DeliverrAPI::DeliverrAddressTest)
    end
  end
