...
# Unit tests for DeliverrAPI::UnauthorizedErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnauthorizedErrorTest do
  let(:instance) { DeliverrAPI::UnauthorizedErrorTest.new }

  describe 'test an instance of UnauthorizedErrorTest' do
    it 'should create an instance of UnauthorizedErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::UnauthorizedErrorTest)
    end
  end
