...
# Unit tests for DeliverrAPI::ApiOrderShipmentStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiOrderShipmentStatusTest do
  let(:instance) { DeliverrAPI::ApiOrderShipmentStatusTest.new }

  describe 'test an instance of ApiOrderShipmentStatusTest' do
    it 'should create an instance of ApiOrderShipmentStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiOrderShipmentStatusTest)
    end
  end
end
