...
# Unit tests for DeliverrAPI::ShippingPlanResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanResponseTest do
  let(:instance) { DeliverrAPI::ShippingPlanResponseTest.new }

  describe 'test an instance of ShippingPlanResponseTest' do
    it 'should create an instance of ShippingPlanResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanResponseTest)
    end
  end
  ...
  describe 'test attribute "external_shipping_plan_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
