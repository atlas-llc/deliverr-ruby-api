...
# Unit tests for DeliverrAPI::AddressTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::AddressTest do
  let(:instance) { DeliverrAPI::AddressTest.new }

  describe 'test an instance of AddressTest' do
    it 'should create an instance of AddressTest' do
      expect(instance).to be_instance_of(DeliverrAPI::AddressTest)
    end
  end
