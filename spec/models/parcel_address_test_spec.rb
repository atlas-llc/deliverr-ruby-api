...
# Unit tests for DeliverrAPI::ParcelAddressTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelAddressTest do
  let(:instance) { DeliverrAPI::ParcelAddressTest.new }

  describe 'test an instance of ParcelAddressTest' do
    it 'should create an instance of ParcelAddressTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelAddressTest)
    end
  end
