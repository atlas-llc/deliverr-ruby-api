...
# Unit tests for DeliverrAPI::ShipmentTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShipmentTest do
  let(:instance) { DeliverrAPI::ShipmentTest.new }

  describe 'test an instance of ShipmentTest' do
    it 'should create an instance of ShipmentTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShipmentTest)
    end
  end
