...
# Unit tests for DeliverrAPI::ShippingCarrierTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingCarrierTypeTest do
  let(:instance) { DeliverrAPI::ShippingCarrierTypeTest.new }

  describe 'test an instance of ShippingCarrierTypeTest' do
    it 'should create an instance of ShippingCarrierTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingCarrierTypeTest)
    end
  end
end
