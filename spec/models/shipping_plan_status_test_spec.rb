...
# Unit tests for DeliverrAPI::ShippingPlanStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanStatusTest do
  let(:instance) { DeliverrAPI::ShippingPlanStatusTest.new }

  describe 'test an instance of ShippingPlanStatusTest' do
    it 'should create an instance of ShippingPlanStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanStatusTest)
    end
  end
end
