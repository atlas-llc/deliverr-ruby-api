...
# Unit tests for DeliverrAPI::WebhookRequestMethodTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookRequestMethodTest do
  let(:instance) { DeliverrAPI::WebhookRequestMethodTest.new }

  describe 'test an instance of WebhookRequestMethodTest' do
    it 'should create an instance of WebhookRequestMethodTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookRequestMethodTest)
    end
  end
end
