...
# Unit tests for DeliverrAPI::ParcelPackageDimensionsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelPackageDimensionsTest do
  let(:instance) { DeliverrAPI::ParcelPackageDimensionsTest.new }

  describe 'test an instance of ParcelPackageDimensionsTest' do
    it 'should create an instance of ParcelPackageDimensionsTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelPackageDimensionsTest)
    end
  end
