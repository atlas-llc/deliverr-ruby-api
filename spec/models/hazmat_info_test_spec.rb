...
# Unit tests for DeliverrAPI::HazmatInfoTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::HazmatInfoTest do
  let(:instance) { DeliverrAPI::HazmatInfoTest.new }

  describe 'test an instance of HazmatInfoTest' do
    it 'should create an instance of HazmatInfoTest' do
      expect(instance).to be_instance_of(DeliverrAPI::HazmatInfoTest)
    end
  end
  describe 'test attribute "hazmat_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "hazmat_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
