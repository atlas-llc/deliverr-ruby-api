...
# Unit tests for DeliverrAPI::StatusCodesACCEPTEDTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesACCEPTEDTest do
  let(:instance) { DeliverrAPI::StatusCodesACCEPTEDTest.new }

  describe 'test an instance of StatusCodesACCEPTEDTest' do
    it 'should create an instance of StatusCodesACCEPTEDTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesACCEPTEDTest)
    end
  end
end
