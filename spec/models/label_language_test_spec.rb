...
# Unit tests for DeliverrAPI::LabelLanguageTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelLanguageTest do
  let(:instance) { DeliverrAPI::LabelLanguageTest.new }

  describe 'test an instance of LabelLanguageTest' do
    it 'should create an instance of LabelLanguageTest' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelLanguageTest)
    end
  end
end
