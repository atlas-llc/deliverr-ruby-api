...
# Unit tests for DeliverrAPI::WebhookTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookTypeTest do
  let(:instance) { DeliverrAPI::WebhookTypeTest.new }

  describe 'test an instance of WebhookTypeTest' do
    it 'should create an instance of WebhookTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookTypeTest)
    end
  end
end
