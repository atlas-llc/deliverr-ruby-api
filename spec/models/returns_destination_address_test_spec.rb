...
# Unit tests for DeliverrAPI::ReturnsDestinationAddressTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsDestinationAddressTest do
  let(:instance) { DeliverrAPI::ReturnsDestinationAddressTest.new }

  describe 'test an instance of ReturnsDestinationAddressTest' do
    it 'should create an instance of ReturnsDestinationAddressTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsDestinationAddressTest)
    end
  end
