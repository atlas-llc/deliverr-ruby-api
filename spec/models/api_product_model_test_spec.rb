...
# Unit tests for DeliverrAPI::ApiProductModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiProductModelTest do
  let(:instance) { DeliverrAPI::ApiProductModelTest.new }

  describe 'test an instance of ApiProductModelTest' do
    it 'should create an instance of ApiProductModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiProductModelTest)
    end
  end
