...
# Unit tests for DeliverrAPI::CurrencyTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::CurrencyTest do
  let(:instance) { DeliverrAPI::CurrencyTest.new }

  describe 'test an instance of CurrencyTest' do
    it 'should create an instance of CurrencyTest' do
      expect(instance).to be_instance_of(DeliverrAPI::CurrencyTest)
    end
  end
end
