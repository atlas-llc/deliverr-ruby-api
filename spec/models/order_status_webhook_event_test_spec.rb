...
# Unit tests for DeliverrAPI::OrderStatusWebhookEventTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderStatusWebhookEventTest do
  let(:instance) { DeliverrAPI::OrderStatusWebhookEventTest.new }

  describe 'test an instance of OrderStatusWebhookEventTest' do
    it 'should create an instance of OrderStatusWebhookEventTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderStatusWebhookEventTest)
    end
  end
