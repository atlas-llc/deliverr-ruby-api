...
# Unit tests for DeliverrAPI::ReturnsApiReturnItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiReturnItemTest do
  let(:instance) { DeliverrAPI::ReturnsApiReturnItemTest.new }

  describe 'test an instance of ReturnsApiReturnItemTest' do
    it 'should create an instance of ReturnsApiReturnItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiReturnItemTest)
    end
  end
