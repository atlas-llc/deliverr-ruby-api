...
# Unit tests for DeliverrAPI::LabelGenerationJobRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelGenerationJobRequestTest do
  let(:instance) { DeliverrAPI::LabelGenerationJobRequestTest.new }

  describe 'test an instance of LabelGenerationJobRequestTest' do
    it 'should create an instance of LabelGenerationJobRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelGenerationJobRequestTest)
    end
  end
  describe 'test attribute "integration_channel_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "estimated_order_count"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
