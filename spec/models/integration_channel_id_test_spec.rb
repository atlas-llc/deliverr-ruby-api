...
# Unit tests for DeliverrAPI::IntegrationChannelIdTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::IntegrationChannelIdTest do
  let(:instance) { DeliverrAPI::IntegrationChannelIdTest.new }

  describe 'test an instance of IntegrationChannelIdTest' do
    it 'should create an instance of IntegrationChannelIdTest' do
      expect(instance).to be_instance_of(DeliverrAPI::IntegrationChannelIdTest)
    end
  end
end
