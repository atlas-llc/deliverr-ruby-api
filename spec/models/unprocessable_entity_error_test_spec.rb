...
# Unit tests for DeliverrAPI::UnprocessableEntityErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnprocessableEntityErrorTest do
  let(:instance) { DeliverrAPI::UnprocessableEntityErrorTest.new }

  describe 'test an instance of UnprocessableEntityErrorTest' do
    it 'should create an instance of UnprocessableEntityErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::UnprocessableEntityErrorTest)
    end
  end
