...
# Unit tests for DeliverrAPI::ShippingLabelResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingLabelResponseTest do
  let(:instance) { DeliverrAPI::ShippingLabelResponseTest.new }

  describe 'test an instance of ShippingLabelResponseTest' do
    it 'should create an instance of ShippingLabelResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingLabelResponseTest)
    end
  end
