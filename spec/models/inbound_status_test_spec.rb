...
# Unit tests for DeliverrAPI::InboundStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InboundStatusTest do
  let(:instance) { DeliverrAPI::InboundStatusTest.new }

  describe 'test an instance of InboundStatusTest' do
    it 'should create an instance of InboundStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::InboundStatusTest)
    end
  end
end
