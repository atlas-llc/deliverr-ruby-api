...
# Unit tests for DeliverrAPI::ReportGenerationRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportGenerationRequestTest do
  let(:instance) { DeliverrAPI::ReportGenerationRequestTest.new }

  describe 'test an instance of ReportGenerationRequestTest' do
    it 'should create an instance of ReportGenerationRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportGenerationRequestTest)
    end
  end
