...
# Unit tests for DeliverrAPI::StatusCodesINTERNALSERVERERRORTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesINTERNALSERVERERRORTest do
  let(:instance) { DeliverrAPI::StatusCodesINTERNALSERVERERRORTest.new }

  describe 'test an instance of StatusCodesINTERNALSERVERERRORTest' do
    it 'should create an instance of StatusCodesINTERNALSERVERERRORTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesINTERNALSERVERERRORTest)
    end
  end
end
