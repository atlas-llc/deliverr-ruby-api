...
# Unit tests for DeliverrAPI::StatusCodesBADREQUESTTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesBADREQUESTTest do
  let(:instance) { DeliverrAPI::StatusCodesBADREQUESTTest.new }

  describe 'test an instance of StatusCodesBADREQUESTTest' do
    it 'should create an instance of StatusCodesBADREQUESTTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesBADREQUESTTest)
    end
  end
end
