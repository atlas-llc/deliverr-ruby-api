...
# Unit tests for DeliverrAPI::ReturnStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnStatusTest do
  let(:instance) { DeliverrAPI::ReturnStatusTest.new }

  describe 'test an instance of ReturnStatusTest' do
    it 'should create an instance of ReturnStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnStatusTest)
    end
  end
end
