...
# Unit tests for DeliverrAPI::PriceTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PriceTest do
  let(:instance) { DeliverrAPI::PriceTest.new }

  describe 'test an instance of PriceTest' do
    it 'should create an instance of PriceTest' do
      expect(instance).to be_instance_of(DeliverrAPI::PriceTest)
    end
  end
