...
# Unit tests for DeliverrAPI::AcceptedSuccessTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::AcceptedSuccessTest do
  let(:instance) { DeliverrAPI::AcceptedSuccessTest.new }

  describe 'test an instance of AcceptedSuccessTest' do
    it 'should create an instance of AcceptedSuccessTest' do
      expect(instance).to be_instance_of(DeliverrAPI::AcceptedSuccessTest)
    end
  end
