...
# Unit tests for DeliverrAPI::ShipmentItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShipmentItemTest do
  let(:instance) { DeliverrAPI::ShipmentItemTest.new }

  describe 'test an instance of ShipmentItemTest' do
    it 'should create an instance of ShipmentItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShipmentItemTest)
    end
  end
