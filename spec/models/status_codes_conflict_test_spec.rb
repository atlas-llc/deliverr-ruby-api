...
# Unit tests for DeliverrAPI::StatusCodesCONFLICTTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesCONFLICTTest do
  let(:instance) { DeliverrAPI::StatusCodesCONFLICTTest.new }

  describe 'test an instance of StatusCodesCONFLICTTest' do
    it 'should create an instance of StatusCodesCONFLICTTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesCONFLICTTest)
    end
  end
end
