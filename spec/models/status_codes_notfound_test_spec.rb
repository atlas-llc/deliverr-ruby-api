...
# Unit tests for DeliverrAPI::StatusCodesNOTFOUNDTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesNOTFOUNDTest do
  let(:instance) { DeliverrAPI::StatusCodesNOTFOUNDTest.new }

  describe 'test an instance of StatusCodesNOTFOUNDTest' do
    it 'should create an instance of StatusCodesNOTFOUNDTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesNOTFOUNDTest)
    end
  end
end
