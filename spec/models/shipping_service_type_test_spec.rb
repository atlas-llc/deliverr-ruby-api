...
# Unit tests for DeliverrAPI::ShippingServiceTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingServiceTypeTest do
  let(:instance) { DeliverrAPI::ShippingServiceTypeTest.new }

  describe 'test an instance of ShippingServiceTypeTest' do
    it 'should create an instance of ShippingServiceTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingServiceTypeTest)
    end
  end
end
