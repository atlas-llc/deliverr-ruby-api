...
# Unit tests for DeliverrAPI::BoxLabelsFormatTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BoxLabelsFormatTest do
  let(:instance) { DeliverrAPI::BoxLabelsFormatTest.new }

  describe 'test an instance of BoxLabelsFormatTest' do
    it 'should create an instance of BoxLabelsFormatTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BoxLabelsFormatTest)
    end
  end
end
