...
# Unit tests for DeliverrAPI::ReturnsSourceAddressTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsSourceAddressTest do
  let(:instance) { DeliverrAPI::ReturnsSourceAddressTest.new }

  describe 'test an instance of ReturnsSourceAddressTest' do
    it 'should create an instance of ReturnsSourceAddressTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsSourceAddressTest)
    end
  end
