...
# Unit tests for DeliverrAPI::InventoryPoolTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InventoryPoolTest do
  let(:instance) { DeliverrAPI::InventoryPoolTest.new }

  describe 'test an instance of InventoryPoolTest' do
    it 'should create an instance of InventoryPoolTest' do
      expect(instance).to be_instance_of(DeliverrAPI::InventoryPoolTest)
    end
  end
end
