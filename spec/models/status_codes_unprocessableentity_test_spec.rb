...
# Unit tests for DeliverrAPI::StatusCodesUNPROCESSABLEENTITYTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesUNPROCESSABLEENTITYTest do
  let(:instance) { DeliverrAPI::StatusCodesUNPROCESSABLEENTITYTest.new }

  describe 'test an instance of StatusCodesUNPROCESSABLEENTITYTest' do
    it 'should create an instance of StatusCodesUNPROCESSABLEENTITYTest' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesUNPROCESSABLEENTITYTest)
    end
  end
end
