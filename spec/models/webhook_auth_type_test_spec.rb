...
# Unit tests for DeliverrAPI::WebhookAuthTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookAuthTypeTest do
  let(:instance) { DeliverrAPI::WebhookAuthTypeTest.new }

  describe 'test an instance of WebhookAuthTypeTest' do
    it 'should create an instance of WebhookAuthTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookAuthTypeTest)
    end
  end
end
