...
# Unit tests for DeliverrAPI::WebhookTypeORDERSTATUSUPDATETest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookTypeORDERSTATUSUPDATETest do
  let(:instance) { DeliverrAPI::WebhookTypeORDERSTATUSUPDATETest.new }

  describe 'test an instance of WebhookTypeORDERSTATUSUPDATETest' do
    it 'should create an instance of WebhookTypeORDERSTATUSUPDATETest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookTypeORDERSTATUSUPDATETest)
    end
  end
end
