...
# Unit tests for DeliverrAPI::ReturnsPublicApiCarriersTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiCarriersTest do
  let(:instance) { DeliverrAPI::ReturnsPublicApiCarriersTest.new }

  describe 'test an instance of ReturnsPublicApiCarriersTest' do
    it 'should create an instance of ReturnsPublicApiCarriersTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiCarriersTest)
    end
  end
end
