...
# Unit tests for DeliverrAPI::BadOrderRequestErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadOrderRequestErrorTest do
  let(:instance) { DeliverrAPI::BadOrderRequestErrorTest.new }

  describe 'test an instance of BadOrderRequestErrorTest' do
    it 'should create an instance of BadOrderRequestErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::BadOrderRequestErrorTest)
    end
  end
