...
# Unit tests for DeliverrAPI::WeightUnitTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WeightUnitTest do
  let(:instance) { DeliverrAPI::WeightUnitTest.new }

  describe 'test an instance of WeightUnitTest' do
    it 'should create an instance of WeightUnitTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WeightUnitTest)
    end
  end
end
