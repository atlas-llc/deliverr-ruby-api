...
# Unit tests for DeliverrAPI::LabelGenerationJobResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelGenerationJobResponseTest do
  let(:instance) { DeliverrAPI::LabelGenerationJobResponseTest.new }

  describe 'test an instance of LabelGenerationJobResponseTest' do
    it 'should create an instance of LabelGenerationJobResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelGenerationJobResponseTest)
    end
  end
