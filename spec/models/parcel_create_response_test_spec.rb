...
# Unit tests for DeliverrAPI::ParcelCreateResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCreateResponseTest do
  let(:instance) { DeliverrAPI::ParcelCreateResponseTest.new }

  describe 'test an instance of ParcelCreateResponseTest' do
    it 'should create an instance of ParcelCreateResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCreateResponseTest)
    end
  end
