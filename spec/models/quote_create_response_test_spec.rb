...
# Unit tests for DeliverrAPI::QuoteCreateResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QuoteCreateResponseTest do
  let(:instance) { DeliverrAPI::QuoteCreateResponseTest.new }

  describe 'test an instance of QuoteCreateResponseTest' do
    it 'should create an instance of QuoteCreateResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::QuoteCreateResponseTest)
    end
  end
