...
# Unit tests for DeliverrAPI::ApiBundleModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleModelTest do
  let(:instance) { DeliverrAPI::ApiBundleModelTest.new }

  describe 'test an instance of ApiBundleModelTest' do
    it 'should create an instance of ApiBundleModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleModelTest)
    end
  end
