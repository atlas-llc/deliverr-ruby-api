...
# Unit tests for DeliverrAPI::OrderApiCreateRequestTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiCreateRequestTest do
  let(:instance) { DeliverrAPI::OrderApiCreateRequestTest.new }

  describe 'test an instance of OrderApiCreateRequestTest' do
    it 'should create an instance of OrderApiCreateRequestTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiCreateRequestTest)
    end
  end
