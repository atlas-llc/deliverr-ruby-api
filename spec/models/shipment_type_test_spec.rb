...
# Unit tests for DeliverrAPI::ShipmentTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShipmentTypeTest do
  let(:instance) { DeliverrAPI::ShipmentTypeTest.new }

  describe 'test an instance of ShipmentTypeTest' do
    it 'should create an instance of ShipmentTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShipmentTypeTest)
    end
  end
end
