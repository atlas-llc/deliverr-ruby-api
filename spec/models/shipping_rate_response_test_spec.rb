...
# Unit tests for DeliverrAPI::ShippingRateResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateResponseTest do
  let(:instance) { DeliverrAPI::ShippingRateResponseTest.new }

  describe 'test an instance of ShippingRateResponseTest' do
    it 'should create an instance of ShippingRateResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateResponseTest)
    end
  end
  ...
  describe 'test attribute "shipping_days"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "arrives_by"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
