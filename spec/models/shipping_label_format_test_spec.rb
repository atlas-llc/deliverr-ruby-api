...
# Unit tests for DeliverrAPI::ShippingLabelFormatTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingLabelFormatTest do
  let(:instance) { DeliverrAPI::ShippingLabelFormatTest.new }

  describe 'test an instance of ShippingLabelFormatTest' do
    it 'should create an instance of ShippingLabelFormatTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingLabelFormatTest)
    end
  end
end
