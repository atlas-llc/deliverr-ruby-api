...
# Unit tests for DeliverrAPI::ReturnsApiInspectionDetailTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiInspectionDetailTest do
  let(:instance) { DeliverrAPI::ReturnsApiInspectionDetailTest.new }

  describe 'test an instance of ReturnsApiInspectionDetailTest' do
    it 'should create an instance of ReturnsApiInspectionDetailTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiInspectionDetailTest)
    end
  end
