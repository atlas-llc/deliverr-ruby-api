...
# Unit tests for DeliverrAPI::ParcelCountryCodeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCountryCodeTest do
  let(:instance) { DeliverrAPI::ParcelCountryCodeTest.new }

  describe 'test an instance of ParcelCountryCodeTest' do
    it 'should create an instance of ParcelCountryCodeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCountryCodeTest)
    end
  end
end
