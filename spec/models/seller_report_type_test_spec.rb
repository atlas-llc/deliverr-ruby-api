...
# Unit tests for DeliverrAPI::SellerReportTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::SellerReportTypeTest do
  let(:instance) { DeliverrAPI::SellerReportTypeTest.new }

  describe 'test an instance of SellerReportTypeTest' do
    it 'should create an instance of SellerReportTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::SellerReportTypeTest)
    end
  end
end
