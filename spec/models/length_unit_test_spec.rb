...
# Unit tests for DeliverrAPI::LengthUnitTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LengthUnitTest do
  let(:instance) { DeliverrAPI::LengthUnitTest.new }

  describe 'test an instance of LengthUnitTest' do
    it 'should create an instance of LengthUnitTest' do
      expect(instance).to be_instance_of(DeliverrAPI::LengthUnitTest)
    end
  end
end
