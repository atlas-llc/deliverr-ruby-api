...
# Unit tests for DeliverrAPI::NotFoundErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::NotFoundErrorTest do
  let(:instance) { DeliverrAPI::NotFoundErrorTest.new }

  describe 'test an instance of NotFoundErrorTest' do
    it 'should create an instance of NotFoundErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::NotFoundErrorTest)
    end
  end
