...
# Unit tests for DeliverrAPI::OrderApiBundleItemTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiBundleItemTest do
  let(:instance) { DeliverrAPI::OrderApiBundleItemTest.new }

  describe 'test an instance of OrderApiBundleItemTest' do
    it 'should create an instance of OrderApiBundleItemTest' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiBundleItemTest)
    end
  end
