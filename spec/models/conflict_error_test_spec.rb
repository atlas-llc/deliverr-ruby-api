...
# Unit tests for DeliverrAPI::ConflictErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ConflictErrorTest do
  let(:instance) { DeliverrAPI::ConflictErrorTest.new }

  describe 'test an instance of ConflictErrorTest' do
    it 'should create an instance of ConflictErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ConflictErrorTest)
    end
  end
