...
# Unit tests for DeliverrAPI::ApiInventoryResponseModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiInventoryResponseModelTest do
  let(:instance) { DeliverrAPI::ApiInventoryResponseModelTest.new }

  describe 'test an instance of ApiInventoryResponseModelTest' do
    it 'should create an instance of ApiInventoryResponseModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiInventoryResponseModelTest)
    end
  end
  ...
  describe 'test attribute "lot_tracking_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
