...
# Unit tests for DeliverrAPI::ContainerSizeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ContainerSizeTest do
  let(:instance) { DeliverrAPI::ContainerSizeTest.new }

  describe 'test an instance of ContainerSizeTest' do
    it 'should create an instance of ContainerSizeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ContainerSizeTest)
    end
  end
end
