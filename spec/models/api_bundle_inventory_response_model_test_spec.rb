...
# Unit tests for DeliverrAPI::ApiBundleInventoryResponseModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleInventoryResponseModelTest do
  let(:instance) { DeliverrAPI::ApiBundleInventoryResponseModelTest.new }

  describe 'test an instance of ApiBundleInventoryResponseModelTest' do
    it 'should create an instance of ApiBundleInventoryResponseModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleInventoryResponseModelTest)
    end
  end
