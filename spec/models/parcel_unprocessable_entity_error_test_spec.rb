...
# Unit tests for DeliverrAPI::ParcelUnprocessableEntityErrorTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelUnprocessableEntityErrorTest do
  let(:instance) { DeliverrAPI::ParcelUnprocessableEntityErrorTest.new }

  describe 'test an instance of ParcelUnprocessableEntityErrorTest' do
    it 'should create an instance of ParcelUnprocessableEntityErrorTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelUnprocessableEntityErrorTest)
    end
  end
