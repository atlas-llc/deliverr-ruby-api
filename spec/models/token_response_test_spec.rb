...
# Unit tests for DeliverrAPI::TokenResponseTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::TokenResponseTest do
  let(:instance) { DeliverrAPI::TokenResponseTest.new }

  describe 'test an instance of TokenResponseTest' do
    it 'should create an instance of TokenResponseTest' do
      expect(instance).to be_instance_of(DeliverrAPI::TokenResponseTest)
    end
  end
