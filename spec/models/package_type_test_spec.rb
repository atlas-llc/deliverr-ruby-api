...
# Unit tests for DeliverrAPI::PackageTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PackageTypeTest do
  let(:instance) { DeliverrAPI::PackageTypeTest.new }

  describe 'test an instance of PackageTypeTest' do
    it 'should create an instance of PackageTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::PackageTypeTest)
    end
  end
  ...
  describe 'test attribute "num_packages"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
