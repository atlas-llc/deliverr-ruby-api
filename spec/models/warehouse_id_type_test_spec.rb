...
# Unit tests for DeliverrAPI::WarehouseIdTypeTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WarehouseIdTypeTest do
  let(:instance) { DeliverrAPI::WarehouseIdTypeTest.new }

  describe 'test an instance of WarehouseIdTypeTest' do
    it 'should create an instance of WarehouseIdTypeTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WarehouseIdTypeTest)
    end
  end
end
