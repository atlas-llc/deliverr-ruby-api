...
# Unit tests for DeliverrAPI::QcItemStatusTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QcItemStatusTest do
  let(:instance) { DeliverrAPI::QcItemStatusTest.new }

  describe 'test an instance of QcItemStatusTest' do
    it 'should create an instance of QcItemStatusTest' do
      expect(instance).to be_instance_of(DeliverrAPI::QcItemStatusTest)
    end
  end
end
