...
# Unit tests for DeliverrAPI::WebhookCreateModelTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookCreateModelTest do
  let(:instance) { DeliverrAPI::WebhookCreateModelTest.new }

  describe 'test an instance of WebhookCreateModelTest' do
    it 'should create an instance of WebhookCreateModelTest' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookCreateModelTest)
    end
  end
  ...
  describe 'test attribute "token_header"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
