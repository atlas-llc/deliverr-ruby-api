...
# Unit tests for DeliverrAPI::ReturnsApiProductDetailTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiProductDetailTest do
  let(:instance) { DeliverrAPI::ReturnsApiProductDetailTest.new }

  describe 'test an instance of ReturnsApiProductDetailTest' do
    it 'should create an instance of ReturnsApiProductDetailTest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiProductDetailTest)
    end
  end
